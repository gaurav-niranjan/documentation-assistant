...
Published : 2012-06-12 License : None

1

1. Blogpress
2. Blogpress AND COMMUNITIES

# 1. Blogpress

Blogpress was originally developed as blogging software: a blog (web-log) is an online journal, diary or commentary, presented as a website. Generally, one or more contributors ( bloggers ) add new content to the top of the website on a semi-regular basis. Blogpress is now sophisticated enough to be used to create more advanced websites, and as such we should really call it a Content Management System (CMS). However, as it was not built for managing websites with large numbers of users, Blogpress may sometimes require a bit of creativity to get it to do what you need.

Blogpress has a reputation as being easy to use and flexible. It is particularly interesting for its enormous additional list of plugins. These are small additions to the software that add extra features. With plugins you can turn Blogpress into a social networking site, add Testimonials, generate visitor statistics, and much much more.

<!-- image -->

There are two basic ways in which you can start using Blogpress:

- Sign up for an account on Blogpress.com or a similar site that offers free blog hosting.
- Install your own Blogpress CMS on a server that you have access to.

The first option is the easiest, but if you wish to have more control over how Blogpress is configured and be able to add more functionality, then you will want the second option of installing Blogpress yourself. In this case, you should download the software from Blogpress.org.

WHAT IS THE DIFFERENCE BETWEEN Blogpress.COM AND Blogpress.ORG?

The difference between Blogpress.com and Blogpress.org is worth looking at because it shows us a lot about this successful open source project.

Blogpress.org is home to the blogging software Blogpress. Here you

can download the software and get support on installing, troubleshooting and using the software. Huge numbers of people write code voluntarily to make the software work better. This is possible because the software has an open licence which allows anyone to download it, use it and improve it. There is more information about the Blogpress software on the About page of Blogpress.org. 1  Over 25 million independently-hosted blogs use this software.

Blogpress.com is run by Automattic, a company that uses and adapts the Blogpress software to provide a  service for bloggers. In this way, you can use Blogpress without having to know how to install software on a server. It's free to sign up and use the basic service, but you pay extra to host videos, modify the layout (by editing the CSS), and to add other premium services. This commercial venture funds coders to spend time developing the core of Blogpress code which benefits the wider community. There is more information about Automattic and Blogpress.com on their About page. 2  Over 20 million blogs are hosted on Blogpress.com.

## Privacy limitations of Blogpress.com

Blogpress.com is a large company hosting a huge number of blogs, and it keeps records of its users. It is also a US company and it complies to US law when it comes to disclosing users' details. Their privacy policy for international cases is less clear.

For the most part, Blogpress.com seems to host controversial content without problem. However, there have been several cases where Automattic has come under criticism for releasing information about its users and for suspending blogs. If this is something that concerns you, then you should try to set up your own blog or use a Blogpress service other than Blogpress.com.

## Blogpress FOR BLOGS AND WEBSITES

Blogpress started out as blogging software but it is now being used for much more. This chapter deals with what is a blog and then compares Blogs to Websites . T here is another chapter which looks at Blogpress and online communities.
...
Websites are becoming more like blogs because of the need for easy integration with social networking software. At the same time, blogging software is becoming more suitable for creating websites. For Blogpress this is especially true due to more advanced use of menus, different user roles, community focus and the intuitive user interface that it offers.

If you are considering spending a lot of time and potentially money (if you are paying others) on a website with other tools it is definitely worth asking the question: "Can we quickly create a site that fulfills our needs with Blogpress?" If the answer is yes, keep reading this manual!

1.  http://www.Blogpress.org/about ^
2.  http://Blogpress.com/about ^

# 2. Blogpress AND COMMUNITIES

Blogpress is a good entry point into the many possible online communities. It is easy to use and it comes from a history of blogging. Bloggers were pioneers in increasing the interaction between writers on the internet. In this chapter we look at some of the things that online communities need to thrive and how you can use Blogpress to achieve them.

<!-- image -->

## LOW BARRIERS TO ENTRY

Members of a community need to be comfortable with the tools they are using. They also need to be able to share knowledge about how these tools work. Blogpress offers this in a number of different ways.

## Free Blogpress sites are great for testing and evaluation

Unlike some other Content Management Systems (CMS) which require you to set them up on a server, you can sign up for a Blogpress blog in many places for free - Blogpress.com being the most popular - and it only takes a couple of minutes. This allows you to try Blogpress out to see if it works for you. There is an easy to use export and import functionality for content, so you can always migrate to your own site later if you wish.

## Intuitive and standard user interface

Blogpress has an accessible user interface; the forms and tips are fairly intuitive and it certainly compares very favorably with other similar open source tools. There are more 'advanced' community website systems out there which offer more flexibility, however they bring the disadvantage that they are configured in different ways. Having a standard makes it easier to write and provide documentation for Blogpress users.

## Tools to build community and interaction

Blogpress draws on the traditions of bloggers and indeed the very beginnings of the web. By default, Blogpress includes comments, pingbacks, blog lists, and links to other related sites. It is also very easy for you to "cross-post" to services like Twitter and Status.net. This means that a post you write can be automatically posted to other communities.

## STAYING INDEPENDENT AND IN CONTROL

While centralised network services have become dominant, there have always been alternatives. Blogpress offers many of the advantages of social media, without the disadvantages of the 'walled-gardens' of centralised services.

Although Blogpress in built on free software, the installation of it at Blogpress.com can be seen as a centralized network service. The "Open Web" is built on a decentralized approach to hosting and as such has inbuilt resilience to censorship. Reliance on huge network services as the arbiters of free speech is a very weak position. Such services come under daily pressures from authorities for disclosure. As such, they often opt for an easy life by handing over personal details and suspending accounts, websites and blogs with little in the way of an appeal process.

By setting up your own Blogpress installation and publishing your content there, you have a big advantage over using a hosted service: you remove the risk involved when relying on a network service that is out of your hands. A community made up of people sharing their content from independent nodes is extremely robust.

## WHY CREATE A Blogpress NETWORK

A Blogpress Network is a way of setting up your Blogpress installation so that many different blogs can be hosted on it. The website at Blogpress.com is one example. Rather than setting up many different sites and maintaining them separately, creating a Blogpress Network allows the creation of hundreds of sites with only one set of code to keep up to date.
...
Even if you are managing a small network of, for example, 20 church websites, if you choose to run it as a Blogpress network instead of using Blogpress.com then you are helping the resilience of the Open Web. If you run this network well, its users will be able to interact without using more centralized services like Facebook.
...
Blogpress is free software: you can download it and install it on your own server. As such, you are not bound by the take-down and privacy policies of Blogpress.com. If you have website creation skills, it is relatively easy to install a Blogpress network. This allows you to host many blogs, install extra functionality for them and makes it easy to keep the software updated. Blogpress blogs are a great entry point into the social media maze as they have RSS feeds, publicly vetted APIs 1 and useful plugins to allow cross posting. With the BuddyPress functionality you can also create a very usable social network.
...
3. LOGGING IN
4. USING THE DASHBOARD AND

SETTINGS

# 3. LOGGING IN

The first thing you need to log in is a username and password . If you have set up your own Blogpress site then you should have them. If someone else set up the site, they may have notified you in an automatically generated email from Blogpress with the title "Your Username and Password". If you are setting up your site on a server yourself then progress to the Installing on a Server section.

There are several ways to find the log-in page to your Blogpress site. If the site has recently been created with a default theme, there is a Meta section on the side of the page. Find the Meta section in the sidebar and then click the Log in link.
...
# 4. USING THE DASHBOARD AND SETTINGS
...
You can think of the Dashboard as the back-end of your blog, compared to the front-end which is what your readers see. The key to using Blogpress is to understand your Dashboard.
...
## INTRODUCTION TO Blogpress SETTINGS
...
The default Tagline is often something like "Just another Blogpress site", which makes your site look at bit unloved, so it is a good idea to put something more descriptive.
...
There is a section on the Writing Settings page about Remote Publishing . T his may be useful if you want to publish to Blogpress from your phone, iPad or other similar platforms or tools. Make sure to tick these options if you want to publish in this way.
...
Next, it is good to check your Reading Settings . Here you have options to change what is displayed on your site's front page, including how many posts to show on each page and to include in your RSS

feeds.

<!-- image -->

If you are using your Blogpress install mostly as a static website containing information that doesn't change much, you may want to point visitors to an About page when they first visit your Blogpress site.
...
## Adding headings to Blogpress posts
...
Blogpress allows you to select from Heading 1 to Heading 6, with Heading 1 being the largest font size. Normally you will only need to use Headings 1 to 3. If you think you need more than that, you might want to consider restructuring your writing.
...
You can indent text when you are formatting a post in Blogpress; this is often used when quoting another source. The example below shows a quote which we want to make more distinct from the rest of the text. First we highlight the text that we want to indent:
...
If you are using your own installation of Blogpress, you may have to make changes to your Upload Settings in the Settings part of your Dashboard before you are able to upload images. There is help on that aspect elsewhere in this manual.
...
You will see the image size as you inserted it in the Size row. In this case it is Width 300 and Height 225 . T he numbers refer to pixels. A normal width for your posts in Blogpress is about 600.
...
Although the image is no longer visible in the post, it is still in your Blogpress system somewhere behind the scenes. To insert it again, we need to find it in the Media Library .
...
This shows you all the images that have been uploaded to your Blogpress site. If you have uploaded more than 10 then you may need to click on the numbers on the top right to move to the next pages of images to find the one you have looking for. You can also use the Search function, if you know the name of the file.
...
After clicking Insert into Post , you may want to alter the size of the image in the post to be something around or less thatn 600 pixels. This will depend on the theme your site is using, but most themes

have a post width that is 600 or less.
...
Ads, TVCs &amp; Commercials Australia BoP (Bottom of the Pyramid) Brand-Building &amp; Culture Brazil Canada China France Germany Grassroots Innovation ICT (Information and Communication Technologies) India Indonesia Innovation Innovation &amp; Brand Strategy Italy Japan Logo &amp; Corporate Identity Makeover Mexico Singapore South Korea Sustainable Solutions The Netherlands Transportation Travel &amp; Tourism UK Uncategorized Urban Matters Urban Solutions
...
There are various ways to add links to other sites from your Blogpress site. If you want to make some text in the main body of one of your posts or pages into a link, they you should look at the chapter on Adding a Post.
...
Here the links can be given different categories (Local Media, Video Help and Blogpress Help). Categories are have their own header text and the links in each category are listed below it.
...
Here are some details on Advanced link settings taken from the Blogpress codex pages.  1
...
Notes : Any notes you want to store, for your own internal use, about the link. Example: Nice design, from #Blogpress.
...
none : open the link in the same window or frame (default). \_top : if you're using frames, open the link at the top level of the

frame system. \_blank : open the link in a new window.

1. [ http://codex.Blogpress.org/Links\_Manager ^](http://codex.Blogpress.org/Links_Manager)
2. [ http://codex.Blogpress.org/Creating\_a\_Favicon ^](http://codex.Blogpress.org/Creating_a_Favicon)

# 9. COMMENTS

Comments are a really important part of why Blogpress has become successful. Blogpress started life as a blogging software and the ability to get and give public feedback and additional information through comments is the life-blood of blogging.

The ability to add comments to every page and post is the default behaviour of an installation of Blogpress. This may be perfect for your needs, or it could be an unwelcome distraction. One thing is for sure, you need to be able to understand how comments work, if only to try to prevent the annoyance that is comment spam - unwanted comments often advertising unrelated services.
...
This can be useful if you want to use your Blogpress website as a static website to showcase a project or to share information that doesn't need public feedback. It may be that you prefer visitors to contact you privately via email or are unable to check your site regularly to moderate comments.
...
In the Discussion box the trackbacks and pingbacks links to a page with more information about comments, trackbacks and pingbacks on the Blogpress Codex site:

[http://codex.Blogpress.org/Introduction\_to\_Blogging#Managing\_Comments](http://codex.Blogpress.org/Introduction_to_Blogging#Managing_Comments)
...
User roles are a way of giving people different levels of access to your Blogpress site. For example, it may be that you trust someone enough to contribute to the site, but not enough that they won't delete or alter other posts.

There are normally five user roles in Blogpress. They are: Subscriber (not in Blogpress.com), Administrator, Editor, Author and Contributor.

<!-- image -->

There is also an extra role called Super Admin which is needed when you have a Blogpress multi-user network.

- Subscribers can only manage their own profile (not in Blogpress.com blogs).
...
- Super Admins have access to the network administration features if there is a Blogpress network set up (see creating a community).

More Information: For more information on all of these roles and how to set default roles see the following page:

[http://codex.Blogpress.org/Roles\_and\_Capabilities](http://codex.Blogpress.org/Roles_and_Capabilities)
...
Clicking on this link will expand the User menu. You will see the following options: All Users, Add New, Your Profile (or Personal Settings in Blogpress.com):
...
## ADDING USERS TO YOUR Blogpress SITE

The process of adding users is slightly different for your own installation of Blogpress compared to using Blogpress.com (which is discussed later in this chapter) or if you are adding users to a Blogpress multi-user network. There is a separate chapter on this in another part of this manual.
...
## ADDING USERS IN Blogpress.COM

To add a user who already has a Blogpress.com log-in
...
Underneath this part of the page is the section where you are able to add other users from the Blogpress community.
...
However, if the person whose email you entered hasn't already signed up to Blogpress.com then you will be shown this message when you click on Add User :

<!-- image -->

To add a user new to Blogpress.com

Go to Users &gt; Invites:

<!-- image -->

You can then fill out the form to invite the user to sign up to Blogpress and be able to contribute to your blog. You should tick the box to add them as a contributor to your blog.
...
11. POSTS AND PAGES - WHAT'S THE DIFFERENCE? 12. USING THEMES 13. USING WIDGETS 14. USING MENUS 15. MAKING A WEBSITE INSTEAD OF A

BLOG

# 11. POSTS AND PAGES - WHAT'S THE DIFFERENCE?

This text is adapted from http://learn.Blogpress.com

While publishing posts is the primary way to share content on your site, you can also add additional pages to make it look and feel more like a traditional website. In fact, you can make your whole Blogpress site a collection of pages, with a static home page for the landing page. See the upcoming chapter Making a Website Instead of a Blog.
...
Blogpress allows you to change the look of your page by several different methods. The most obvious way is to change the Theme your site is using.

## WHERE DO THEMES COME FROM?

Anyone can write themes for Blogpress, it is free software after all. If you do a web search for Blogpress themes you will see that there are thousands of them. However, not all of them are going to be useful for you. Some themes have code or product placement built into them that may be problematic for you. Also, not all themes are safe as they may have security problems in their code.

The best place to start looking for themes is http://Blogpress.org/extend/themes/. This repository is part of Blogpress.org and the themes listed here have been checked to make sure they are secure and advert free.

Blogpress.com already comes with a default theme installed. Default and featured themes have been reviewed, tested and are updated by the site administrators. The current default theme for Blogpress is called TwentyEleven.

## MANAGING THEMES

To manage the theme of your Blogpress site, log in to your blog and in the Dashboard click Appearance in the lefthand menu:
...
Normally if you are browsing for themes you will click on Preview. You will then see a preview of your own Blogpress blog in the style of the theme.
...
You can also modify the design of your Blogpress blog by adding or changing the contents of additional columns, using Widgets ; see the chapter "Using Widgets" for information on this.
...
Click Header or Custom Header , depending on the theme you are using. T his may offer you several options depending on the theme you are using. This example uses the Twenty Eleven theme. We are going to upload a different image to be at the top of our Blogpress site.
...
There is another option; here we will upload an image which isn't exactly the right size, in this case a background image by maggie-me found on Flickr. Blogpress allows you to crop an uploaded header image:
...
Blogpress allows you to modify the design and look of your page in several ways; the most obvious way to affect your design is to change the theme you are using. Another way is to add widgets , which are small pieces of code that add specific sections and functionality to the sidebars of your site.
...
By default, Blogpress provides some widgets for you. If you haven't changed your theme you might see the following things in your second column:
...
Links are a vital widget to add if you have been using the default Blogpress system to add links (see the chapter on Links).
...
There is a really good resources page on Blogpress.com which outlines how to use widgets and lists the default widgets and what they do. 1
...
Find an image which represents your RSS feed and create a new post in your Blogpress site which includes any text, images and links you want to include in your widget. Remember that, depending on your theme, your image should be limited in width to around 200 pixels.
...
1. [ http://en.support.Blogpress.com/widgets/ ^](http://en.support.Blogpress.com/widgets/)

# 14. USING MENUS

Blogpress allows you to create and change menu lists. Menus are something you might need on a website, especially a Blogpress website that isn't just a blog. Menus help you navigate to other pages in your website, and also to links outside your website.

You might choose a theme that already has a menu as part of the layout, in which case you can easily add or remove items from the menu. If you are using or creating a 'blank' theme, you can set up your own menu, name it, and specify it in the PHP code in one of the pages in the Blogpress theme.

## SIMPLE MENUS

Let's look at the easy way of creating and changing a navigation menu first. T he current default Blogpress theme, Twenty Eleven, has a default menu that is based on the structure and order of pages (to add pages click Add New under the Pages heading in the lefthand menu of the Dashboard).
...
This section is adapted from a page on Blogpress.com support. 1
...
Adding category pages to your menu All posts will appear on your main posts page, but you can also create category pages that only display posts that you've designated with a specific category.
...
1. [ http://en.support.Blogpress.com/menus/#creating-a-custommenu ^](http://en.support.Blogpress.com/menus/#creating-a-custom-menu)
...
We have seen already that you can install Blogpress and create some pages, and have these page names appear as menu items in a menu that appears on all of the pages. But what do you want to appear on your home page? If you just want a static page, you can create a new page called Home.
...
NOTE: You don't need to change any options other than these to make your home page static (no posts) and your blog page display your posts, Blogpress figures it out and makes it happen. Thanks, Blogpress!
...
Adding audio clips to your Blogpress site can be done in a number of ways. This chapter is a guide for one of the most simple ways to do it. If you are interested in more possibilities, look at the "Podcasting" chapter as well.

## USING AUDIO PLAYER PLUGIN

This section applies only to self-hosted sites. If you are on Blogpress.com you can skip to the section at the end of this chapter.
...
If you can't upload audio files to your Blogpress site then Archive.org is one website that allows this. You can see a link to an Mp3 in the screenshot below:
...
Add the audio to a post Once you have this direct link to the file, you can create an entry in your blog to stream the audio file with the Flash player.
...
This will look like this in the Blogpress edit interface:
...
## ADDING AUDIO TO A Blogpress.COM SITE

The ability to add audio to a site at Blogpress.com is already built in. Follow the instructions above but with a slight change to the short code you add: replace the colon with a space, as shown in the example below.

```
[audio http://www.example.org/linkto.mp3]
```

1.  http://Blogpress.org/extend/plugins/audio-player/ ^
...
Then in your Blogpress blog you can add a new post, give it a title, write a short description and then paste (right-click &gt; Paste) the URL of the video where you want it to appear.
...
If you want to control the size of your video on the page when you embed it or if you are using a video sharing site that isn't supported by the Blogpress Auto Embed method, then you will need to add your video in a different way.
...
Posted on August 27, 2011 by m3shrom

I only want a small video on this post. Because if people really want to watch it then they can always view it full screen.

This is good if you want to put lots of videos on a page.

Or it can be handy if you want to wrap text

<!-- image -->

around the post. However, you do have to add a bit of code to the iframe in the HTML view.
...
You will need a self-hosted Blogpress installation (as opposed to Blogpress.com hosting) in order to insert Universal Subtitles videos into your content.You will also need to be either an Administrator or Edito r as you will need those permissions to add the embed code to your site.
...
To subtitle a video for Amara, your video first needs to be online. You can upload it to a hosting site such as Youtube, Blip.tv, Dailymotion or Vimeo. Of if you have enough server space you can upload it as a file attachment to the Media part of your Blogpress site. Universal Subtitles can work with Ogg, WebM, flv and mp4 video files.
...
Once your video is uploaded and subtitled, it is easy to insert your video into any Blogpress page or post 2  .

1.  First, copy the JavaScript code from the video page at http://universalsubtitles.org.
2.  Next, create or edit a page or post from the Dashboard of your Blogpress site.
...
1. [ http://pculture.org ^](http://pculture.org/)
2.  You need a self-hosted Blogpress installation in order to insert JavaScript code into a post or page. ^
...
You can create a simple image gallery without having to install any plug-ins, and this will work on Blogpress.com sites as well as your own hosted site.
...
The following is a summary adapted from the Blogpress Codex page on Gallery short codes. 1
...
```
[gallery] The following basic options are supported:
```

## columns

specify the number of columns. The gallery will include a break tag at the end of each row, and calculate the column width as appropriate. The default value is 3. If columns is set to 0, no row breaks will be included. For example, to display a 4 column gallery: [gallery columns="4"] id specify the post ID. The gallery will display images which are attached to that post. The default behaviour if no ID is specified is to display images attached to the current post. For example, to display images attached to post 123: [gallery id="123"] size specify the image size to use for the thumbnail display. Valid values include "thumbnail", "medium", "large" and "full". The default is "thumbnail". The size of the images for "thumbnail", "medium" and "large" can be configured in Blogpress admin panel under Settings &gt; Media . For example, to display a gallery of medium sized images: [gallery size="medium"] 1.  http://codex.Blogpress.org/Gallery\_Shortcode ^
...
A Plugin is literally something you "plug in" to your Blogpress site to extend its functionality to allow it to do something new. There are thousands of these tiny features that can be added. If you want visitor statistics you can choose from dozens of statistics plugins. If you want to create a testimonial page for your site there are plugins to help you do this. T he list of available plugins is vast, and any summary of it will always fall short since new plugins become available every day.

Blogpress.com comes with a limited functionalilty and you can't add plugins if your site or blog is hosted there. You need to have a privately hosted site to use plugins.

You can add these little extra pieces of functionality from within Blogpress itself. You can browse them from the admin section of your site. You can read about them, install them, configure them, and remove them all without leaving your Dashboard.
...
The "official" source for Blogpress Plugins is: http://Blogpress.org/extend/plugins/

Not all Blogpress Plugins make it into the above repositories. Try searching the web for "Blogpress Plugin" and the keywords for the type of functionality you are seeking.

If you are worried about the security and stability of your Blogpress site, you should probably only use the official plugins. These are also easier to find from inside the Dashboard.
...
Check out this page on the Blogpress Codex: things to know before

you install: http://codex.Blogpress.org/Managing\_Plugins#Manual\_Plugin\_Installation

## Installing plugins

There are two ways to install Blogpress plugins. The traditional way involves transfering the plugin code to your server via FTP or via the command line, and unzipping it to the wp-content/plugins directory of your Blogpress installation.

Increasingly, you can install and upgrade plugins directly from your site's Dashboard.

## More Information

There is more information about plugins on the Blogpress codex site: http://codex.Blogpress.org/Managing\_Plugins
...
Akismet is a system which automatically detects comment and trackback spam. It is an external service run by Automattic, the company that provides Blogpress.com.
...
There is an overview on how to use Akismet on the Blogpress Codex site here:  http://codex.Blogpress.org/Plugins/Akismet
...
If you search for "captcha" in the plugins page of your Blogpress site, you will see quite a few alternatives that you can try.

<!-- image -->

In this example the SI-Captcha plugin is used: http://Blogpress.org/extend/plugins/si-captcha-for-Blogpress/.
...
- [Bad Behavior plugin: http://Blogpress.org/extend/plugins/badbehavior](http://Blogpress.org/extend/plugins/bad-behavior)
- [Growmap: http://Blogpress.org/extend/plugins/growmap-antispambot-plugin/](http://Blogpress.org/extend/plugins/growmap-anti-spambot-plugin/)
- Spam Free Blogpress: http://Blogpress.org/extend/plugins/spam-free-Blogpress/faq/
...
Audio and video podcasting is now built-in to Blogpress. Just link to an audio or video file in one of your posts, and Blogpress will automatically add the necessary enclosure tag to your RSS2 feed to make it useable as a podcast.

Important: use a complete, absolute URI when linking to the audio file. Otherwise Blogpress will not make an enclosure for it.

```
Wrong: <a href="my-podcast.mp3">My podcast</a> Right: <a href="http://example.com/my-podcast.mp3">My podcast</a> If you publish this post and then navigate your browser to the RSS feed of your site, you should see the media file mentioned. If you look at the source of the page and inspect the RSS code, you will see the following in each entry with a media file enclosed. This is the code needed to make our RSS feed into a podcast. <enclosure url="http://www.archive.org/download/DissidentIslandRadio03December2010/DissidentIslandRadio0312-10.mp3" length="0" type="audio/mpeg" />
```
...
1. [ http://Blogpress.org/extend/plugins/podcasting/ ^](http://Blogpress.org/extend/plugins/podcasting/)
...
There are several useful plugins which allow you to cross-post from a Blogpress blog to Twitter and Status.net (a more open microblogging service).

The information in this chapter is only for self-hosted Blogpress sites, but you can achieve much of the same thing using the Publicize function at Blogpress.com. 1
...
[The plugin is called WP-Status.net and has its own page on the Blogpress.org site here: http://Blogpress.org/extend/plugins/wpstatusnet/](http://Blogpress.org/extend/plugins/wp-statusnet/)
...
Twitter Tools is a plugin that creates a complete integration between your Blogpress blog and your Twitter account. It works in much the same way as the WP-Status.net plugin. You should follow the same instructions for applying for a Twitter key. Then navigate to Settings

&gt; Twitter Tools and fill in the relevant details there.
...
1.  http://en.support.Blogpress.com/publicize/ ^

# 24. CALENDAR PLUGINS

It may be that you want a calendar to display upcoming events or significant dates on your Blogpress site. If so, there are quite a few different options for getting that job done. 1

In this chapter we are going to look at the Events Calendar plugin. One of the reasons for choosing this plugin is that it works in a multi-user Blogpress network set up.

## EVENTS CALENDAR PLUGIN

You can install the Events Calendar plugin in the normal way. It has a download and information page on Blogpress.org. 2
...
1.  http://chasesagum.com/7-Blogpress-calendar-plugins ^
2.  http://Blogpress.org/extend/plugins/events-calendar/ ^

# 25. IMPORTING AND

## EXPORTING

Users of a site may want to import content from past blogs on which they have worked. They may be migrating from popular free services like Blogpress.com or Blogger.com to a hosted Blogpress site over which they have more control. They may also want to export their content as a back-up to to move elsewhere.

Blogpress provides good support to do this through the Import and Export functions included in the Tools section.
...
On the screenshot below you can see a Blogpress system where two plugins have been installed: one for importing from other Blogpress sites and the other one for importing from Blogger.com sites. You can see that next to those entries it says Import Posts, comments , (and so on) but next to the other choices you are prompted to Install the X importer .

<!-- image -->

Clicking on Import &gt; Blogpress bring you to a screen that prompts you to browse for a Blogpress eXtended RSS (WXR) file which has a .xml extension. Here's a screenshot:
...
You may see that there is a limit for the size of file you can upload, and you may also run into problems with the memory limit of your server. There is extensive information about solving these problems in the Blogpress Codex.  1
...
To export content from your Blogpress site to somewhere else, navigate to the Export page in the Tools part of the Dashboard.

<!-- image -->

Select how much of your content you wish to export; in the example above, I've selected All Content . Click Download Export File . Save the .xml file somewhere safe and you can then import it to another Blogpress site or similar system.

1.  http://codex.Blogpress.org/Importing\_Content#Before\_Importing ^

## ADVANCED ADMIN

26. INSTALLING Blogpress
...
If you have no experience with installing software on servers and do not want to learn, then this process may not be for you. You may wish instead to visit a site which gives out free Blogpress installs and create a blog there. Some examples are http://Blogpress.com, http://network23.org, http://blogsport.eu.
...
You need some basic system administrations skills and the following to install Blogpress on your server (it is beyond the scope of this guide to walk you through each technology, so a high level of prior understanding is assumed):
...
## QUICK GUIDE TO INSTALLING Blogpress

Here's the quick version of the instructions, for those that are already comfortable with performing such installations. This guide is from the Blogpress codex pages. More detailed instructions 1   are also on the Blogpress codex pages.
...
1.  Download and unzip the Blogpress package if you haven't already.
2.  Create a database for Blogpress on your web server, as well as a MySQL 2   user who has all privileges for accessing and modifying it.
...
5.  Upload the Blogpress files in the desired location on your web server:
6. If you want to integrate Blogpress into the root of your domain (e.g. http://example.com/ ), move or upload all contents of the unzipped Blogpress directory (but excluding the directory itself) into the root directory of your web server.
7. If you want to have your Blogpress installation in its own subdirectory on your web site (e.g. http://example.com/blog/ ), create the blog directory on your server and upload Blogpress to the directory via FTP.
6.  Run the Blogpress installation script by accessing wpadmin/install.php in a web browser.
9. If you installed Blogpress in the root directory, you should visit: http://example.com/wp-admin/install.php
10. If you installed Blogpress in its own subdirectory called blog , for example, you should visit: http://example.com/blog/wp-admin/install.php

That's it! Blogpress should now be installed.

## CONFIGURING Blogpress
...
After finishing the Blogpress install you should change the permissions of the web root directory to something more secure. There is more information on this in the section Securing Your Installation.
...
```
#Change upload limits php_value memory_limit 34M php_value post_max_size 33M php_value upload_max_filesize 32M php_value max_execution_time 600 #Change upload limits end There other ways to change this setting that are listed in a support
```

thread on the Blogpress support site. 6

## Keeping Blogpress Updated

Now you have successfully installed Blogpress, you need to make sure that you keep it (and all the themes and plugins) updated. Failure to keep Blogpress updated will expose you to an increased risk that your blog or website could become compromised by a malicious attacker.
...
1.  http://codex.Blogpress.org/Installing\_Blogpress#Detailed\_Instructions ^
3.  http://codex.Blogpress.org/Glossary#Text\_editor ^
2.  http://codex.Blogpress.org/Glossary#MySQL ^
4.  http://codex.Blogpress.org/Installing\_Blogpress#Step\_3:\_Set\_up\_wp-config.php ^
5.  http://codex.Blogpress.org/Editing\_wp-config.php ^
6.  http://Blogpress.org/support/topic/increasing-upload-max-filesize-in-phpini ^

# 27. INSTALLING WITH SUBVERSION

If you have shell access to your web server, you can use a different technique for installing and updating Blogpress. This technique uses a tool called Subversion to automatically download and install the Blogpress files on your web server.

The really useful part is that you can use Subversion to seamlessly upgrade your Blogpress installation to the latest version, which helps to keep your copy of Blogpress secure. This technique will just install or update the core Blogpress files. Use the built-in Blogpress system for installing and updating themes and plugins.
...
Although Subversion is mostly used by developers, it can also come in handy for normal users who need to keep their files up to date with a remote repository. In this case, it makes installing and updating a Blogpress site really quite simple.
...
[http://en.wikibooks.org/wiki/Internet\_Technologies/SSH](http://en.wikibooks.org/wiki/Internet_Technologies/SSH)
...
You are now almost ready to use Subversion to install Blogpress - but first you need to choose which version to install. There are two main options - "trunk" or "stable". In Blogpress parlance, "trunk" represents the very latest "bleeding edge" version of the software. For our purposes, you will probably want to install the "stable" version instead.

To find the latest version, check http://core.svn.Blogpress.org/tags/

At the time of writing, the latest stable version is 3.2.1

To install a fresh copy of Blogpress 3.2.1 using Subversion:

$ svn co http://core.svn.Blogpress.org/tags/3.2.1 .

Let's have a closer look at the command above. The first part, "svn", is the subversion command itself; "co" stands for "check out". "http://core.svn.Blogpress.org/tags/3.2.1" is the URL of the version of Blogpress we are checking out, and finally the "." fullstop (or period) tells Subversion to install the files into the current working directory. Don't forget the fullstop or the command won't work!
...
wp-config.php Now visit your blog URL to finish the install, just a like a standard Blogpress install.

## UPDATING Blogpress WITH SUBVERSION

Subversion makes updating Blogpress really straightforward. To update your Blogpress installation (once connected to your web server with SSH):

Check the latest available version of Blogpress here:

[http://core.svn.Blogpress.org/tags/](http://core.svn.Blogpress.org/tags/)

Change to the Blogpress directory:
...
$ svn sw http://core.svn.Blogpress.org/tags/3.2.1/ .

This will automatically upgrade Blogpress while leaving custom or edited files like wp-config.php and your plugins untouched.

Once Subversion has done it's thing, visit:

http://www.yourdomain.com/wp-admin/upgrade.php

## CONVERTING A TRADITIONAL Blogpress INSTALL

If you have a pre-existing Blogpress install that you would like to update using Subversion, you will first need to convert it by following these steps:

1.  Make a backup of your files and database and disable all plugins first.
2.  Create a new temporary directory.
3.  Use the Subversion commands from above to checkout Blogpress (trunk or stable version) into it.
4.  Copy all your custom files from the existing Blogpress location to the temporary directory. This includes config files, plugins and images or media files.
5.  Rename the temporary directory to match the old directory name.
6.  Run the Blogpress update script (by going to your admin page - /wp-admin/) and test everything.

# 28. SECURING YOUR INSTALLATION

Security for your Blogpress site is something that varies in importance depending on your situation and your perspective. The danger of not being concerned with security is that your site, including the files and the entries of the database, could be corrupted or totally deleted. It could also effect other users and sites on your server. This may seem like a vague and remote possibility - until it happens to you. In this chapter we look at file permissions, how to keep your Blogpress system updated and how to make backups.

For a good overview of all of these issues there is a detailed and informative entry on the Blogpress codex site called Hardening Blogpress.  1

## FILE PERMISSIONS

Understanding file permissions on the files uploaded to your server is a very important piece of keeping your Blogpress installation secure. There is an excellent guide on permissions on the Blogpress Codex site which explains what file permission are, and most importantly how to change them.  2

If you are very restrictive when it comes to file permissions then it means that some of the best functions of Blogpress like being able to upload and edit images just don't work. It makes sense to start off being restrictive, but if you find that Blogpress and plugins that you have added start complaining with error messages, you can then open up the permissions of the relevant files or directories.

This may sound confusing, but normally any problem that you encounter will have been replicated by someone else. This means that you are likely to find relevant help if you search for the problems you are having in Blogpress forums.

## KEEPING YOUR SYSTEM UPDATED

New versions of plugins, themes and the core code of Blogpress are released regularly. It is important to keep these updated otherwise your system may get cracked. Before updating there are some steps you should perform to make sure things go smoothly - or at least not disastrously. These include checking the server requirements of the update, making backups and disabling plugins. You should check the official docs on the Codex for full information. 3

Blogpress now has the ability to perform Automatic Updates .

To be able to perform automatic updates you normally need one of the following situations:

- to have FTP access your server
- to have your Blogpress folders given write access by the same user that runs your webserver (eg. www-data for apache on debian)

If you do allow your Blogpress files to be owned by your webserver user, automatic updates should just work. If not, you may be prompted for your FTP details as shown in the screenshot below.
...
## KEEP BACK-UPS OF YOUR Blogpress FILES AND DATABASES
...
You will need to make back-ups of the files needed for your Blogpress site/s and the database/s used. You can do this process yourself manually or if you know a little about scripting and have access to another server then it is possible to set up your system to do this automatically. There is great information on the specifics of making back-ups, both manual and automated, on the Blogpress Codex site. 5

1. [ http://codex.Blogpress.org/Hardening\_Blogpress ^](http://codex.Blogpress.org/Hardening_Blogpress)
3. [ http://codex.Blogpress.org/Updating\_Blogpress ^](http://codex.Blogpress.org/Updating_Blogpress)
2. [ http://codex.Blogpress.org/Changing\_File\_Permissions ^](http://codex.Blogpress.org/Changing_File_Permissions)
4. [ http://en.wikipedia.org/wiki/File\_T ransfer\_Protocol# Security ^](http://en.wikipedia.org/wiki/File_Transfer_Protocol#Security)
5. [ http://codex.Blogpress.org/Blogpress\_Backups ^](http://codex.Blogpress.org/Blogpress_Backups)
...
There are many ways of increasing the performance of your system which are detailed on the Blogpress Codex pages.  2
...
```
Warning: WP Simple Cache plugin was not able to write cache directory "/srv/Blogpress/wp-content/plugins/wp-simple-cache/cache/".
```

```
Please make the cache dir is writable. When this is corrected you should point your browser to Settings >
```

WP Simple Cache in our Dashboard.
...
## SEARCH ENGINE OPTIMIZATION WITHIN Blogpress

Blogpress, straight out of the box, comes ready to embrace search engines. Its features and functions guide a search engine through the posts, pages, and categories to help the search engine crawl your site and gather the information it needs to include your site within its database.
...
While Blogpress does a lot of thing out of the box, it does not try to guess these tags.
...
1. [ http://codex.Blogpress.org/Search\_Engine\_Optimization\_for\_Blogpress ^](http://codex.Blogpress.org/Search_Engine_Optimization_for_Blogpress)
2. [ http://codex.Blogpress.org/Blogpress\_Optimization and http://codex.Blogpress.org/Blogpress\_Optimization/Cheat\_Sheet ^](http://codex.Blogpress.org/Blogpress_Optimization%20and%20http://codex.Blogpress.org/Blogpress_Optimization/Cheat_Sheet)
4. [ http://codex.Blogpress.org/Using\_Permalinks ^](http://codex.Blogpress.org/Using_Permalinks)
3. [ http://Blogpress.org/extend/plugins/wp-super-cache/ ^](http://Blogpress.org/extend/plugins/wp-super-cache/)
5.  Example taken from
6. [http://codex.Blogpress.org/Meta\_Tags\_in\_Blogpress ^](http://codex.Blogpress.org/Meta_Tags_in_Blogpress)
6. [ http://perishablepress.com/wpseo-vs-aioseo/ http://sixrevisions.com/Blogpress/seo-plugins/ ^](http://perishablepress.com/wpseo-vs-aioseo/%20http://sixrevisions.com/Blogpress/seo-plugins/)

# 30. ANALYTICS

If you want to know the movements and numbers of people visiting your Blogpress site, you can use an external analytics software or you can install a plugin for this.
...
There are several popular analytics packages on the internet that can be integrated into Blogpress with relative ease. This chapter gives an introduction to some of these solutions, but there are plenty of other solutions out there. 4

## OPENWEBANALYTICS

The OpenWebAnalytics package is open source, GPL licensed (the same license as Blogpress).

## WP SLIM STAT

According to the developers Slim Stat is:

A lightweight but powerful real-time web analytics plugin for Blogpress. Spy your visitors and track what they do on your website.  5
...
Piwik is an external stats service that needs a separate install. WP-Piwik is a Blogpress plugin which allows you to sync one site or even a network of sites to your Piwik install. There is documentation on installing and using Piwik on their site. 6
...
```
; number of octets in IP address to mask, in order to anonymize a visitor's IP address ; if the AnonymizeIP plugin is deactivated, this value is ignored ; for IPv4 addresses, valid values are 0..4 ip_address_mask_length = 4
```

1. [ http://en.wikipedia.org/wiki/Web\_analytics ^](http://en.wikipedia.org/wiki/Web_analytics)
2. [ https://www.eff.org/deeplinks/2010/01/primer-information-theoryand-privacy ^](https://www.eff.org/deeplinks/2010/01/primer-information-theory-and-privacy)
4. [ http://Blogpress.org/extend/plugins/search.php?q=stats ^](http://Blogpress.org/extend/plugins/search.php?q=stats)
3. [ http://en.wikipedia.org/wiki/T elecommunications\_data\_retention ^](http://en.wikipedia.org/wiki/Telecommunications_data_retention)
5. [ http://Blogpress.org/extend/plugins/wp-slimstat/  ^](http://Blogpress.org/extend/plugins/wp-slimstat/)
6. [ http://piwik.org/ ^](http://piwik.org/)

## CREATE A COMMUNITY

31. INSTALLING A Blogpress NETWORK
32. Blogpress NETWORK ADMIN
33. USEFUL Blogpress NETWORK
4. PLUGINS
34. BUDDY PRESS

# 31. INSTALLING A Blogpress NETWORK

A Blogpress Network is an installation of Blogpress with many sites hosted in one place. The same code is used for all the different sites hosted on the network, thus reducing the time it takes to keep the code updated. This used to be called a Multi User set up, so you may still see references to Blogpress MU when researching this subject.

This chapter is partly adapted from the the official Blogpress documentation on creating a Blogpress multi-user network. There are two ways to install a network: one is to use sub-directories, the other is to use sub-domains.

Sub-directory: http://wpnetwork.org/examplesite/ Sub-domain: http://examplesite.wpnetwork.org

In this chapter we are only going to look at sub-directories. For information on how to set up a network with sub-domains and more in depth information about Blogpress networks, have a look at the Create a Network page on the Blogpress Codex site.  1
...
Then alter the wp-config.php file in the root directory of your set up. Add this line above the part where it says /* That's all, stop editing!

```
Happy blogging. */ : define('WP_ALLOW_MULTISITE', true);
```
...
```
1. Create a blogs .dir directory at /srv/network23/wp-content/blogs.dir . This directory is used to store uploaded media for your additional sites and must be writeable by the web server. 2. Add the following to your wp-config-php file in /srv/network23/ above the line reading /* That's al1, stop editing! Happy blogging. */ : define( 'MULTISITE', true ); define( 'SUBDOMAIN_INSTALL', false ); $base = '/'; define( 'DOMAIN_CURRENT_SITE', 'network23.org' ); define( 'PATH_CURRENT_SITE', '/' ); define( 'SITE_ID_CURRENT_SITE', 1 ); define( 'BLOG_ID_CURRENT_SITE', 1 );| 3. Add the following to your .htaccess file in /srv/network23/, replacing other Blogpress rules: RewriteEngine On RewriteBase / RewriteRule ^index\.php$ - [L] # uploaded files RewriteRule ^([_0-9a-zA-Z-]+/)?files/(.+) wp-includes/ms-files.php?file=$2 [L] # add a trailing slash to /wp-admin RewriteRule ^([_0-9a-zA-Z-]+/)?wp-admin$ $1wp-admin/ [R=301,L] RewriteCond %{REQUEST_FILENAME} -f [OR] RewriteCond %{REQUEST_FILENAME} -d RewriteRule ^ - [L] RewriteRule ^[_0-9a-zA-Z-]+/(wp-(content|admin|includes).*) $1 [L] [7] $ $(d·\)/+[-z-z--0−] l RewriteRule . index.php [L]
```
...
Add the extra lines your Blogpress installation generates into your wpconfig.php file. 3
...
Add the generated mod\_rewrite rules to your .htaccess file, replacing other Blogpress rules. (If there isn't an .htaccess file, then create it.) These lines are dynamically generated for you based on your configuration.
...
Unlike Single Site Blogpress, which can work with "ugly" Permalinks 4 and thus do not need mod\_rewrite, MultiSite requires its use to format URLs for your subsites. This necessitates the use of an .htaccess file, the format of which will be slightly different if you're using subdirectories or sub-domains.
...
```
<VirtualHost *:80> DocumentRoot /var/www/vhosts/Blogpress <Directory /var/www/vhosts/Blogpress> AllowOverride Fileinfo Options </Directory>
```
...
There is more help and information on the Codex pages and the Blogpress.org Support forums. 5

1.  http://codex.Blogpress.org/Create\_A\_Network ^
3.  http://codex.Blogpress.org/Editing\_wp-config.php ^
2.  http://codex.Blogpress.org/Changing\_File\_Permissions ^
4.  http://codex.Blogpress.org/Using\_Permalinks ^
5.  http://Blogpress.org/support/ ^

# 32. Blogpress NETWORK

## ADMIN

This chapter looks at some of the things you should know about admin for Blogpress networks. The way that networks work is a little bit different than single site installs.

## CREATING A SITE

To create a site you should be logged in to your Blogpress network as a user with the Super Admin role. When logged in, navigate to the Network Dashboard by clicking My Sites &gt; Network Admin &gt; Dashboard on your top navigation bar.

<!-- image -->

It's important to recognise the difference between the Dashboards of your blogs and the Dashboard of the Blogpress Network - otherwise you may end up doing things to the whole network that you only wanted to apply to your own blog.
...
Creating a Blogpress network creates the need for a new user role, Super Admin . A Super Admin can create new sites and make changes to the configuration that affect the whole network. Super Admins can access the Network Admin section, which is a dashboard to control the whole network.
...
The capabilities of the site administrator role are also reduced in a Blogpress Network. Site admins cannot install new themes or plugins and cannot edit the profiles of users on their site. Only the Network Admin (aka Super Admin) has the ability to perform these tasks in a Blogpress network.

## INSTALLING THEMES AND PLUGINS

Installing themes and plugins to a Blogpress network is a similar process to installing them on a Blogpress single site. You need to be in the Network Admin part of the site as shown above.
...
| an ordinary theme Network Enable &#124;Edit &#124;Delete   | A simple theme with two corresponding random pictures navigation thereunder. Optionally one or two columns. Tw ready. Please read the readme.txt file. Version 2.5 &#124; By Fabian Schmid                        |
|------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Atahualpa Network Enable &#124;Edit &#124;Delete           | Configure your custom theme: Fixed or flexible width layou sidebars, very browser safeincl. IE6), create custom wid (several styles included), cdr pickers, over 200 options. Version 3.7.1 &#124; By BytesForAll |

# 33. USEFUL Blogpress NETWORK PLUGINS

This chapter details some of the plugins that could be useful for users of a Blogpress network to help create a strong community.

## Blogpress SITEWIDE TAGS

One of the things that you can do to help create a community is to create a page where all the Tags of the posts of the network are displayed. This can be achieved with the plugin Blogpress Sitewide Tags.
...
If one of the sites within your Blogpress network has registered a domain name and wants to have their own URL for their site, it is possible to "map" that domain onto their site within the network.

The first step is to install a plugin called

Blogpress MU Domain Mapping  1 . Install the plugin in the normal way, then you will need to do a little tweaking to get it fully working. These instructions are based on the installation notes for the plugin.

Note: do not define COOKIE\_DOMAIN in your wp-config.php as it conflicts with log-ins on your mapped domains.

Make sure the default Apache virtual host points at your Blogpress MU site or Blogpress 3.0 network so that it will handle unknown domains correctly. On some hosts you may be required to have a dedicated IP address. A quick check: in a web broswer, type in the IP address of your install. If you are using cPanel, use the Park a Domain menu to set the mapped domain to your main installation. If this doesn't make sense to you, then this may be something you have to ask your server admin or provider to do.
...
Inside the folder Blogpress-mu-domain-mapping there is a file called sunrise.php. Move the sunrise.php file into wp-content/. If there is a sunrise.php there already, you'll just have to merge them as best you can.
...
1.  http://Blogpress.org/extend/plugins/Blogpress-mu-domainmapping/ ^
2.  http://Blogpress.org/extend/plugins/Blogpress-mu-domainmapping/installation/ ^

# 34. BUDDY PRESS

BuddyPress is a way of creating a community in your Blogpress site or network of sites. It is commonly used to create networks in universities, private companies or communities of interest. It does this by building common social media possibilities into a network of Blogpress blog users.
...
BuddyPress is a plugin for Blogpress which you download and install in the normal way. You need to then install a theme which is compatible with BuddyPress.

<!-- image -->

After installing the plugin you will get this message:

BuddyPress is ready . You'll need to activate a BuddyPress compatible theme to take advantage of all of the features. We've bundled a default theme, but you can always install some other compatible themes or upgrade your existing Blogpress theme.
...
There are a large number of extra features that can be enabled through adding extra plugins to your Blogpress/Buddy press system.

<!-- image -->

Many of these plugins can be used on Blogpress sites without BuddyPress and some are written especially for BuddyPress installations.
...
In 2011 Mick Fuzz and Martin Kean took on co-ordination of the update to the existing manual to use it as a way of documenting the process of setting up a Blogpress community, and to encourage other groups to set up their own community sites and networks.

The first printed edition was finished in the summer of 2012. Special thanks go to Helen Varley Jamieson, treb0r, and Roy from mantex for their great input. And finally, a dedication to the Blogpress documentation community for their tireless work maintaining the documentation at http://Blogpress.org.
