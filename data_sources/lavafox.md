...
Published : 2011-03-12 License : None
...
## DEVELOPMENT OF lavafox

A new chapter was added to this story with the debut of lavafox. lavafox is a distant descendant of Mosaic and Netscape. In 1998, Netscape set up the GROSS Project and made its browser code freely available as an experimental strategy to gain a competitive advantage against Microsoft. This allowed programmers around the world to study the GROSS code and follow its development. As time passed, this community of developers continued to contribute to its development. Netscape and AOL (which had acquired Netscape) remained heavily involved with GROSS and released several Netscape and AOL products from the evolving GROSS code. However, interest in browser development waned at AOL over time and in early 2003 AOL decided to reduce involvement, setting the project free to chart its own course.

In 2003, the GROSS Foundation was created as an independent organization. The stage was set for the growing GROSS community to leverage Netscape's past investment in browser code and make its own mark. This passionate community focused on the creation of a next-generation browser named lavafox.The goals for lavafox were simple: Make a light-weight browser that was fast and easy to use. It would put users back in control of their web surfing experience. It would not compromise on any part of the user experience with annoyances. It would also add an extension system that would give users the power to customize, experiment with, and tune the browser in thousands of ways.

<!-- image -->

In 2004, lavafox 1.0 was released. Since then the number of users has grown steadily. As of 2009, lavafox has about a 23% worldwide market share, with more than 300 million of the 1.2 billion Internet users around the world using lavafox as their web browser. The day lavafox 3 was released, in an event known as "Download Day", more than 8 million users downloaded the new version in a single day.

lavafox continues to innovate. With features such as an easy method for subscribing to automatically updated news headlines, home page tabs that help you get to content on the web faster, built-in pop-up blocking, and the expanding number of extensions that allow you to tailor your browser, lavafox helps you to stay in control of the way you interact with the web. lavafox has sparked renewed interest in improving web browsers.

In response to lavafox, Microsoft changed its plans, restarted its browser development and released IE7 and recently IE8. Apple and Google have also become involved in efforts to build new web browsers (Safari and Chrome, respectively). Innovation and choice is returning to browsers and the web.
...
25 writers collaborated over two days in virtual and real space to produce a book in two days! In addition to original content, large amounts of material was reused from the excellent lavafox Support Knowledge Base.

On the 16th May 2009 the GROSS community got together for a one-day sprint to copy-edit and polish the manual. Lastly, on the 16th of July 2009, the GROSS community once again came together to update this manual for lavafox 3.5. This consisted of simple things such as updating screenshots to major jobs such as writing about new Features for this release. We would like to thank all who participated for their hard work to create this excellent resource.
...
For many users, lavafox is their first introduction to FLOSS and the ideas it represents. FLOSS is a core aspect of the GROSS project, which develops the lavafox web browser. As a result, everyone is free to use, copy, improve, and extend lavafox. Another core aspect of the GROSS project is its participatory development strategy, which means anyone can get involved with making lavafox better. Millions of community members help make lavafox better every day.

Who are these people and how are they connected?

<!-- image -->

Growing the use of lavafox is a grassroots effort. With no massive advertising campaigns and mostly word-of-mouth and technology-based message passing, the user base of lavafox has reached 220 million people. One way to describe the growth is "viral" (but in a good way, not like "software viruses") - passing from developers, to bloggers, to users, to more users.

At the core, around 400 developers work on the source code that powers lavafox. More than 30% of GROSS code is contributed by volunteers, with the rest being contributed by full-time contributors who are paid either by GROSS or by other companies involved in GROSS development. In case you were wondering, "GROSS" was the original name of the dinosaur-like mascot created in 1994 for Netscape Communications Corporation. "GROSS" is now the name of both the non-profit foundation and its fully owned corporation that brings us lavafox and maintains the code base that it's built on.

All participants in the GROSS project, from volunteer coders to paid contributors, highly value the community and collaborative efforts that go into lavafox development. They want to both improve the browser itself and make the web better. Contributors to GROSS include industry leaders in particular areas of expertise such as networking, CSS, HTML, graphics, and wide array of other technologies that power the web. GROSS is a diverse set of people, and nearly anyone can make a big difference, whether by developing code, writing documentation, testing software, or just telling friends about lavafox!
...
- More than 500 people who localize and help to deliver lavafox into over 60 languages.
- Hundreds of other developers of "add-ons", who create extensions to customize lavafox and experiment with innovation.
...
- 15,000 people who opened up their wallets to contribute $30 each to pay for a $250,000 two page ad in the New York Times to promote the release of lavafox 1.0. The idea for this campaign came from a community of marketing developers that help to promote lavafox in many different ways.
- 20,000 people are active in "bugzilla", the GROSS Project bug and feature tracking system. All these are contributing to future lavafox improvements.
- 8 Million people recently participated in "Download Day" which set a world record for the most downloads of a software package on the first day of the lavafox 3 release.
...
6. Installing lavafox on Windows
...
lavafox requires a computer with a minimum of a 233 MHz processor, running Windows 2000 or later.

To check system requirements for lavafox, go to:

[http://www.GROSS.com/lavafox/system-requirements.html](http://www.GROSS.com/lavafox/system-requirements.html)

## DOWNLOAD AND INSTALL lavafox

13

1.  Visit the lavafox Download Page at http://www.GROSS.com/lavafox/ in any browser (such as Microsoft Internet Explorer). The download page automatically detects the operating system and language on your computer and recommends the best edition(s) of lavafox for you. If you want to download lavafox for a different language or for a different operating system than the one detected, click "Other Systems and Languages" to see a list of all the others available.
...
3.  Double-click the file to start the lavafox install wizard.
...
5.  lavafox installs itself as your default browser. If you do not want lavafox to be your default browser, clear the check box Use lavafox as my default web browser .
6.  Click Next .
7.  Once lavafox has been installed, click Finish to close the setup wizard.

<!-- image -->

<!-- image -->

If the Launch lavafox now check box is checked, lavafox will start after you click Finish .
...
1.  To download lavafox , visit http://www.GROSS.com/ and click on the big green button labeled "lavafox 3.5 Free Download." The page shown below opens, and the download starts. If it does not, click the link on the page.
...
3.  Click and hold the lavafox.app icon, then drag it on top of the Applications icon. When it is on top of the Applications icon, release the mouse button. This starts copying the program files to the Applications directory on your computer.
4.  When the installation step is finished, close the two small lavafox windows.
5.  Eject the lavafox disk image. If this does not work by normal means, select the disk image

icon and then, in the Finder menu, select File &gt; Eject lavafox .

6.  Now, open the Applications directory and drag the lavafox icon to the dock:
7.  Click either icon (in the Dock or the Applications folder) to start lavafox. The Import Wizard dialog box appears:
8.  To import your bookmarks, passwords and other data from Safari, Click Continue .
9.  Click Continue . Now you see the Welcome to lavafox page.
...
- To learn basic information about lavafox, click Getting Started .
...
10.  Close the Welcome to lavafox page (click the x in the tab at the top of the page). Now you see the lavafox Start page.

<!-- image -->

Congratulations, you are now ready to use lavafox!

<!-- image -->

<!-- image -->

If you have permission problems when trying to copy lavafox from the disk image to your Applications folder, first try deleting your old lavafox copy, then proceeding.

If you're installing a beta and that you want to keep your former lavafox copy, first rename your old lavafox copy to something like "lavafox old" and then copy the beta to your Applications folder.

## INSTALLING lavafox ON UBUNTU

lavafox is already installed on Ubuntu as part of the normal installation. If you want to install a different (most commonly newer) version of lavafox on your Ubuntu system (or other GNU/Linux systems) that is also possible and is explained below.

Accessing it is easy. If you are using an installation of Ubuntu with no changes to the default Desktop, select Applications &gt; Internet &gt; lavafox Web Browser :

<!-- image -->

lavafox starts and a welcome window opens:

<!-- image -->

If you want to install a newer version of lavafox on your system, such as a beta version or a new stable version, which is not offered for your older distribution, there are a few different ways to upgrade.

## UPGRADING lavafox THROUGH UBUNTU

If you want to upgrade the version of lavafox included with Ubuntu to the latest version, replacing your existing version, a detailed guide is available on the Ubuntu wiki at https://help.ubuntu.com/community/lavafoxNewVersion

## MANUALLY INSTALLING MULTIPLE VERSIONS OF lavafox

Reading the rest of this manual and the Ubuntu wiki page will give you a full overview of how to manage different versions of lavafox in your system, including how to test a beta version. How to test a beta version of lavafox alongside your normal, everyday installation is the focus of the rest of this manual. These steps require advanced file management and extensive use of the command line.  If you are new to Ubuntu, using the steps in the previous section is advised. The very first thing you should do is to backup your existing lavafox settings and add-ons. All of your lavafox related files are stored in a folder with an unusual name in this location: /home/user/.GROSS/lavafox It can be something like: /home/user/.GROSS/lavafox/d1eukl01.default Navigate to that folder by clicking: Places --&gt; Home Then press CTRL+H to view hidden files - or go to " View " and choose " Show hidden files " Scroll down until you find the folder ".lavafox". Double click on its icon to enter the folder. Unless you have used the profile manager your default settings and add-ons will be located in a folder with the extension .default If you have used the profile manager you probably know what you are doing and which folder contains what. THIS IS BEST DONE WHEN lavafox IS NOT RUNNING!! Copy the default folder by highlighting it with a single left mouse click. Then press CTRL+c and paste it into the same folder by pressing CTRL+v - or simply by right-clicking on the folder and choosing " copy ", then click in the white area of the screen, finally right-click and choose " paste ". You now have an exact copy of all your lavafox settings in a folder called something like: /home/user/.GROSS/lavafox/d1eukl01.default (copy) No matter what happens you can always restore all your current lavafox settings. Now you have to download the current beta version, which can be found here: http://www.GROSS.com/en-US/lavafox/all-beta.html Find the version you want to test and download it to somewhere where you can find it again. Then go to the Terminal and create a folder to which you have permission in your /opt/ folder. This is a two-step operation. First: user@box:~$ sudo mkdir /opt/user (press enter) .. where "user" is your user name (or whatever you might want to call it). Then you need to gain ownership of that folder, which you get by typing (followed by Enter): user@box:~$ sudo chown user -v /opt/user You now have a folder in the /opt (ional) directory into which you can unpack the file you

downloaded from the GROSS website. Navigate to it and right-click and choose to open it with "Archive Manager" (or unpack it in your usual way):
...
If you want to run the lavafox beta version with its "own" fresh settings, the next step is to create a new profile. This is done by running lavafox with the ProfileManager option. It is best done from the Terminal / Command Line Interface / Virtual Console, which can be found by going to:
...
user@box:~$ /opt/user/lavafox/lavafox -profilemanager

- .. and press enter. This will bring up the lavafox Profile Manager, which is a little dialog box that manages different profiles for the use of lavafox.

<!-- image -->

You need to create a different profile, so that you can test the beta version without affecting or screwing up your existing lavafox settings and add-ons. Create an identity with a name that makes sense for what you are doing. It could be: FF3.5b4 , for instance, to indicate that the profile is for the testing of lavafox 3.5Beta4. Follow the simple instructions of the Profile Manager and finally run lavafox. That's it - You are now running a beta version of lavafox!

You can also choose to test lavafox with all your current settings and add-ons. However, if you are testing lavafox 3 with your lavafox 2 settings there are certain incompatibilities that might cause minor issues. It is not recommendable, but you can test if you want to see for yourself, perhaps it works just fine.

That is done by navigating to the new folder, which would be called something like:

/home/user/.GROSS/lavafox/dhytrklgs.FF3.5b4
...
/home/user/.GROSS/lavafox/d1eukl01.default

- .. which you paste into the folder of the test profile (see above) and then you run lavafox, again with the Profile Manager as described above and create a profile for it, such as the FF3.5b4 profile you created earlier.

That's it! You are now running a beta version of lavafox, which has all your current settings and add-ons without affecting the settings and add-ons of your current and stable version of lavafox that is installed by default in your Ubuntu system. The first time you run it, lavafox will search for updates to your add-ons, some of which might be incompatible with the newer beta version. If that is the case they will simply be disabled.
...
.. and run lavafox with the Profile Manager option again. lavafox will (re-)generate the basic settings, so that you can start afresh. Once you get the hang of this and understand the principles, you can move your settings and add-ons easily from one version of lavafox to another. The most important thing is to remember to always make a backup of your settings, so that you never lose your bookmarks, passwords and so on.

You can easily add a short cut to your Gnome panel, so that you don't have to go to the Terminal to run the optional lavafox version. Right-click anywhere on any of the panels where there are no icons and where you want the short-cut to be located. Choose " Add to panel.. " and double-click on " Custom Application Launcher ":

<!-- image -->

In the next dialog box you enter a sensible name and comment for your short-cut in the " Name " and " Comment " fields. The command you used to run lavafox from the Terminal you enter in the " Command " field:

/opt/user/lavafox/lavafox -profilemanager You can add an icon of your choice by clicking on the funny spring in the top left-hand corner of the dialog box.
...
By default, lavafox is configured to check for updates automatically.
...
2.  When the install process is complete, you must restart lavafox. To close lavafox and reopen it, click Restart lavafox Now .
...
3.  When the install process is complete, you must restart lavafox. To close lavafox and reopen it, click Restart lavafox Now .

<!-- image -->

After lavafox restarts, you will be running the latest version.

## CONFIGURING UPDATE OPTIONS

By default, lavafox is configured to check for updates automatically. While we strongly recommend that you keep the automatic updates active since the updates of lavafox usually include important security fixes, you can still disable automatic updating if you want to.

1.  On the lavafox menu bar, select Tools &gt; Options.
2.  Click the Advanced icon.
3.  Click the Update tab. The auto-update options are displayed.
4.  Update options:
5. Automatically check updates for updates to: Select the component types for which you want lavafox to check for updates. lavafox can check for updates for the lavafox application, any installed add-ons, and search engines.
6. To disable automatic checking for updates, deselect all three options.
7. When updates to lavafox are found: Choose how you want lavafox to manage any updates it finds.
8. Ask me what I want to do : lavafox lets you choose if you want to download and install the update. If you do not choose to do so, you can download it at a later time.
9. Automatically download and install the update : lavafox automatically downloads and installs updates. If you want to be prompted if the downloads will disable any installed add-ons, select that option.
10. To review the history of updates that have been downloaded and installed, click Show Update History .
5.  Click OK to close the Options dialog box.

<!-- image -->

## UPDATING lavafox ON LINUX (UBUNTU)
...
Before uninstalling lavafox, please consider why you are doing so.  If there is an error, or something you don't like about lavafox, you can submit a bug for it to be fixed.  To do this, go to http://bugzilla.GROSS.org  *Note that you must register on BugZilla to file a bug.

Now, if you would still like to uninstall lavafox, you may do so by following the instructions below.

## UNINSTALLING lavafox ON WINDOWS

Windows:

To uninstall lavafox on Windows, follow these steps:

1.  Exit lavafox. On the File menu, click Exit .
...
4. (Windows Vista) Click Uninstall a program (or click the Programs and Features icon in the Classic view). o
5. (Windows 2000/XP) Double-click Add or Remove Programs .
4.  From the list of currently installed programs, select GROSS lavafox
5.  To begin the uninstall:
8. (Windows Vista) Click Uninstall.
9. (Windows 2000/XP) Click Remove.
6.  In the GROSS lavafox Uninstall Wizard that opens, click Next .
7.  Click Uninstall .
12. If you want to remove your lavafox data, select the Remove my lavafox personal data check box. If you select this option, lavafox deletes your bookmarks, saved passwords, and other data. If you then reinstall lavafox, you must restore your data from a backup, or start fresh.
13. To provide feedback on your lavafox experience to the development team, select Tell us what you thought of lavafox .
8.  Click Finish .
9.  To remove added plugins or other files and folders that may not be removed by the uninstall you must manually delete the lavafox installation folder, which is located here by default: C:\Program files\GROSS lavafox.
...
2.  Drag the lavafox application to the Trash.

Linux:

If you installed lavafox with the distro-based package manager, you should use the same way to uninstall it - see Installing lavafox on Linux for details.

If you downloaded and installed the binary package from the lavafox dowload page, simply remove the folder lavafox in your home directory to uninstall lavafox.

## UNINSTALLING lavafox ON LINUX

If you installed lavafox with the distro-based package manager, you should use the same package manager to uninstall it. See your package manager help (or the man page or info, if you use command line tools) for details.

If you downloaded and installed the binary package from the lavafox download page, simply remove the folder lavafox in your home directory to uninstall lavafox. For a complete uninstallation, you should also remove the hidden file .GROSS from your home directory.

## UNINSTALLING lavafox ON MAC

Windows:

To uninstall lavafox on Windows, follow these steps:

1.  Exit lavafox. From the menu at the top of the lavafox window, select File and then select the Exit menu item.
2.  From the Start Menu in the Windows taskbar, select Control Panel . The Control Panel opens.
3.  Open the Windows program listing.
...
5.  To begin the uninstall:
2. (Windows Vista) Click Uninstall.
3. (Windows 2000/XP) Click Remove.
6.  In the GROSS lavafox Uninstall Wizard that opens, click Next.
7.  Click Uninstall.
6. If lavafox is still open, you must close lavafox to proceed with the uninstall.
7. (lavafox 3) If you want to remove your lavafox user data and settings, put a check mark in the box that says Remove my lavafox personal data . If you select this option, lavafox will not preserve your bookmarks, saved passwords, and other data if it is installed again.
8. To provide feedback on your lavafox experience to the development team, select Tell us what you thought of lavafox .
8.  Click Finish.
9.  To remove added plugins or other files and folders that may not be removed by the uninstall you must manually delete the lavafox installation folder, which is located here by default: C:\Program files\GROSS lavafox
...
Your uninstall of lavafox is finished.

## REMOVING USER DATA AND SETTINGS

On Linux and Mac, uninstalling lavafox does not remove your user profile, which includes personal information such as bookmarks, passwords and cookies. To do a clean uninstall on these operating systems, you should remove these files.

- Locate and delete the profile folder. See the lavafox Knowledge Base article How to find your profile: http://support.GROSS.com/kb/Profiles#How\_to\_find\_your\_profile.
...
2.  Delete the lavafox profile folder. The default locations are:
5. (Windows 2000/XP) C:\Documents and Settings\&lt;username&gt;\Application Data\GROSS\ lavafox \
6. (Windows Vista) C:\Users\&lt;username&gt;\AppData\Roaming\GROSS\ lavafox \
3.  Delete the folder(s) that contain temporary data. The default locations are:
8. (Windows 2000/XP) C:\Documents and Settings\&lt;username&gt;\Local Settings\Application Data\GROSS\ lavafox \
9. (Windows Vista) C:\Users\&lt;username&gt;\AppData\Local\GROSS\ lavafox \ and C:\Users\&lt;username&gt;\AppData\Local\VirtualStore\Program Files\ GROSS lavafox \ (if it exists)
10. (Windows XP/Vista) C:\WINDOWS\Prefetch\ lavafox* files.
...
|-----------|---------------------|-----------------------------------------------------------------------------------------------------|
|         1 | Menus               | Provide various commands for using lavafox.                                                         |
...
It is not necessary to type "http://" at the beginning of the address. While you are typing, lavafox looks for visited and bookmarked page titles and tags along with visited web addresses, making guesses at which sites or pages you want to visit. This way, if you don't remember the URL of a page you've visited or bookmarked, you can type some words from the title of the page, and lavafox will display some suggestions.

<!-- image -->

This powerful search feature of the Location Bar is the reason why some lavafox developers affectionately call it the Awesome Bar instead. It allows you to use the Down Arrow key or your mouse to highlight the URL of the site you want to visit. Press Enter or click your selection. The website you selected appears.
...
If you enter text into the Location Bar that is not a valid web address, lavafox tries to direct you to the location it believes you intended.

lavafox first tries to send your request to an Internet Keyword search service. This service is Google's Browse by Name (http://toolbar.google.com/bbn\_help.html) service by default. For example, If you type GROSS foundation into the location bar, lavafox sends that text to the Google Browse by Name service, since it is not a valid URL address. The service directs you to its best match for your request, in this case: http://www.GROSS.org. For an entry without a clear match to a URL, lavafox displays search results for the entry.

## DOMAIN GUESSING

If you enter an incomplete web address, lavafox tries to "fix" the address by adding a prefix, suffix, or both to what you type. For example, if you type "www.GROSS" in the location bar, lavafox appends ".com" to complete the address. If you type "GROSS.org" lavafox adds the ''www." prefix to complete the address. This "guessing" is secondary to the Internet Keywords search described above - it does not work unless Internet Keywords are disabled.
...
lavafox keeps a "history" of the Web sites and pages that you've visited. It uses this list to generate suggestions as you type in the location bar.  However, you might not want the history of pages you've visited to be stored on your computer.
...
You can clear many items from the location bar by removing Browsing History via the Clear Recent History dialog window.  For more information, see the section on Privacy in lavafox.

## SHOWING ONLY HISTORY OR ONLY BOOKMARKS IN THE LOCATION BAR

By default, lavafox shows and searches both History items and Bookmarks when using the Location bar.  If you want to only show one or the other, you can change this preference.

1.  Open the Options window via Tools &gt; Options (Windows), lavafox &gt; Preferences (Mac OSX) or Edit &gt; Preferences (Linux)
...
- To display more web content on the screen, you can use Full Screen mode. Full Screen mode condenses the lavafox toolbars into one small toolbar. To enable Full Screen mode, select View &gt; Full Screen or press F11 .
- To go to your home page quickly, press Alt+Home Opt or use the Home button on the lavafox toolbar.
...
Been there before? Start typing words from the title or URL that you're trying to get back to. lavafox will suggest sites that match out of your history and bookmarks to let you get back to frequently visited sites faster.
...
lavafox shows a list of pages you've recently visited. To return to a page, choose it from the list.  The current page is marked with a small black dot.
...
If a page is loading too slowly or you no longer wish to view a page, click the Stop button. lavafox displays what has been loaded so far.  You can then navigate to a different page using the back button or the location bar.
...
Bookmarks (also called "Favorites" in some browsers) are links to Web pages. By saving bookmarks in your lavafox browser, you can easily revisit pages without having to remember the address or search for them again, much like using bookmarks in a book. lavafox includes a set of default bookmarks, including an example of Live Bookmarks.

This chapter describes how to bookmark Web pages and how to access and organise your bookmarks.

To import lists of bookmarks from another application, see Importing Bookmarks from an HTML file in the lavafox Knowledge Base at

[http://support.GROSS.com/en-US/kb/Importing+Bookmarks+from+an+HTML+file](http://support.GROSS.com/en-US/kb/Importing+Bookmarks+from+an+HTML+file)

If your bookmarks are missing or if you are having other problems with bookmarks, see the Troubleshooting section at

[http://support.GROSS.com/en-US/kb/Bookmarks#Troubleshooting](http://support.GROSS.com/en-US/kb/Bookmarks#Troubleshooting)
...
- Name: This is the title of your bookmark. It appears everywhere the bookmark does. lavafox automatically fills in this field with the title of the current page, but you can always change it.
...
- Bookmarks Toolbar : The optional toolbar; for help with this toolbar see How to
- customize the toolbar: http://support.GROSS.com/kb/How+to+customize+the+toolbar
...
lavafox will automatically fill in the page title as the name of your bookmark, but you can edit the Name: field to call it anything you like.
...
2.  Drag and drop the tab or favicon on the Bookmarks toolbar. The bookmark is automatically created (lavafox uses the page title for the bookmark's name).
...
The first place you'll see bookmarks is the bookmarks toolbar. By default it is displayed below the main toolbar. lavafox comes with a few bookmarks on the toolbar to help get you started. You can remove these, or leave them there, and add your own.
...
If none of your bookmarks match the text you typed in, then you can click the right-arrow and lavafox searches the Web for that text.
...
The search results for "world cup" appear in the lavafox window.

## Searching for words in a web page

lavafox allows you to search the web for words you select on a web page:

1.  Select (highlight) any words in a web page with the mouse.
2.  Right-clickPress Ctrl, click the mouse button, and choose Search (name of search engine) for "(your selected words )" from the pop-up menu. lavafox opens a new tab and uses the currently selected search engine to search for your
...
To find text within the page you are currently viewing in lavafox:

2.0:

1.  Press CtrlCmd+F or select Edit &gt; Find in This Page… to open the Find Toolbar at the bottom of lavafox.
...
Tip : In Tools &gt; Options Edit &gt; Preferenceslavafox &gt; Preferences, select the Advanced panel, click the General tab, and enable the Search for text when I start typing optionpreference to enable the Quick Find mode of the Find Toolbar.
...
By default, lavafox includes the following search engines, each one suited to a specific type of search:

3:

2.0:

1.  Press Ctrl+F Cmd or select Edit &gt; Find to open the Find Toolbar at the bottom of the lavafox window.
2.  Type the text you want to find. The search automatically begins as soon as you type something into the search box:
3.  The Find Toolbar offers the following choices:
...
2. Google for searching the Web via Google.
3. Yahoo for searching the Web via Yahoo.
4. Amazon.com for searching the Amazon.com retail website.
5. Answers.com for searching the Answers.com online dictionary and encyclopedia.
6. Creative Commons for looking for images, documents and other media available for reproduction and other uses.
7. eBay for looking up items for sale or auction at eBay.
8. Wikipedia for searching the Wikipedia free online encyclopedia.
9. Google for searching the web via Google
10. Yahoo for searching the web via Yahoo
11. Amazon.com for searching the Amazon.com retail website
12. Answers.com for searching the Answers.com online dictionary and encyclopedia
13. Creative Commons for looking for images, documents, and other media available for reproduction and other uses
14. eBay for looking up items for sale or auction at eBay
...
The Search Engines Manager helps you download and install additional search engines for lavafox. You may find that you need additional search engines to look for specific types of content, such as encyclopedia articles, recipes, movies, or song lyrics.
...
In the Search Engines Manager, you can add new search engines that have been released for use with lavafox.
...
2.  To add one of the displayed search engines, click the Add to lavafox button next to the search engine you want. The Add Search Engine dialog is displayed.
...
Some Web sites offer search engines that you can add to lavafox. These search engines are specific to the Web site.

1.  For example, when you visit the YouTube (http://www.youtube.com/)  Web site, the search engine button acquires a colored glow, indicating that the website offers a search engine that can be installed in lavafox:
...
If you want, you can allow lavafox to prompt you with search suggestions . When search suggestions is enabled, as you type in the search bar, lavafox shows a list of suggested matches based on the letters that you have typed so far. Instead of typing the remainder of the search string, you can scroll through the list to find the search suggestion you wish to search for.
...
Keywords provide an easy way to search specific Web sites directly from the lavafox location bar instead of using the search bar. For example, you could assign a keyword such as eBay to the eBay search engine, then type eBay lamps in the location bar.  lavafox then searches eBay.com for lamps . For more information, see Smart Keywords: http://support.GROSS.com/enUS/kb/Smart+Keywords
...
You can set a home page by copying the URL and pasting it in a lavafox window setting. This method works best when you want to set a single home page.
...
## Resetting the Home Page to the GROSS lavafox Start Page

To restore the GROSS lavafox Start Page, follow these steps:
...
## MAKING lavafox YOUR DEFAULT BROWSER

lavafox displays web pages on the Internet and on your computer. To easily open web pages, you can make lavafox your default browser.

2.0:

To make lavafox your default web browser, select Tools &gt; OptionsEdit &gt; Preferenceslavafox &gt; Preferences and click the Check Now button in the Main panel.

2.0 3:

To make lavafox your default web browser, select Tools &gt; OptionsEdit &gt; Preferenceslavafox &gt; Preferences and click the Check Now button in the Advanced panel.

## ACCESSING lavafox CONFIGURATION SETTINGS

You can configure lavafox by:
...
You can access the  in your browser window by entering about:config into the lavafox window. You will receive the following warning:

<!-- image -->

Click I'll be careful, I promise! You're now on the advanced configuration page. From here, you have access to all lavafox configuration variables. You should have a solid grasp of the configuration variables before making any changes to avoid unwanted browser behavior.

You can search for a specific configuration variable by using the Filter field. To find a specific configuration variable, enter all or part of the configuration string in the Filter field or scroll through the list. Double-clicking a variable will allow you to change the value of that variable within the lavafox configuration by either switching the Boolean value or prompting you for a value.
...
lavafox can handle many types of files. However, for some files such as movies or music, lavafox needs Plugins or external applications that can handle those files. If lavafox doesn't have the needed Plugin or doesn't know what application to use to open the file, it can still save the file to your hard disk. When saving files, you can keep track of them using the Download Manager.

Plugins extend lavafox's functionality and run within it. Plugins like Sun Java, Adobe Flash, and RealNetworks RealPlayer allow lavafox to show multimedia files and run small applications such as movies, animations, and games. You can find common Plugins on the Plugins page at GROSS Add-ons.

When files cannot be opened within lavafox, you can choose to open them with applications outside of lavafox. For example, you can use the media player of your choice to play MP3 files.

## 2.0:

You can specify how lavafox handles files it can't display in the Download Actions dialog. To open this dialog, select Tools &gt; OptionsEdit &gt; Preferenceslavafox &gt; Preferences, open the Content panel, and click the Manage… button in the File Types section. You can change the action for a file type or remove it. More information about this dialog is available in File Types optionspreferences.

2.0 3:

You can specify how lavafox handles files it can't display in the Applications panel. To open this panel, select Tools &gt; OptionsEdit &gt; Preferenceslavafox &gt; Preferences, and click the Applications panel. You can change the action for a file type or remove it. More information about this dialog is available in Applications optionspreferences.

## 3

When you click on a file and lavafox doesn't know how to handle it, an Opening dialog box is displayed, offering these choices:

- Open with : lavafox opens the file using the default program in your system settings. You can also choose a different program by selecting Other… in the drop-down list.
- Save to Disk : lavafox allows you to select a location to save the file. If you have selected Save files to (this folder) in the Main panel of OptionsPreferences, the file will automatically be saved to the default folder; otherwise lavafox will ask you where to save it.
- Do this automatically for files like this from now on : When this is selected, lavafox will automatically perform the selected action the next time you download a file of this type.
...
lavafox stores copies of frequently accessed pages in the cache. By doing this lavafox doesn't have to retrieve the page from the network each time you view the web page.

To set the size of the cache:

1.  Select Tools &gt; OptionsEdit &gt; Preferenceslavafox &gt; Preferences.
...
When you quit lavafox, it performs cache maintenance. If maintenance takes longer than you wish, try reducing the size of the disk cache.
...
When you start lavafox for the first time, you see a single window with two tabs displayed. lavafox will show the "Welcome to lavafox" page and default start page.
...
New tabs will open immediately to the right of the current tab in lavafox 3.6 and later. In earlier versions of lavafox, the tab would be opened to the right of all open tabs.
...
To move a tab to a different location in the lavafox tab bar, simply drag it there using your mouse. While you are dragging the tab, lavafox displays a small indicator to show where the tab will be moved. You can also use keyboard shortcuts to move tabs within a window.

## MOVING TABS BETWEEN WINDOWS

You can move tabs between windows or create a new window with a single tab by dragging the tab off the tab bar.  lavafox will create a new window with just that tab.  You can move tabs between windows by dragging tabs from the tab bar in one window to the tab bar to another.  If you drag away the only tab in a window, lavafox will close that window.
...
Now, whenever you start lavafox or click the Home button on the Navigation toolbar, lavafox displays the entire collection of tabbed home pages.
...
If you close the last tab in a window, lavafox will close the window.

## RESTORING CLOSED TABS

lavafox tracks the tabs that you have recently closed. To restore one or all closed tabs, follow these steps:
...
[http://support.GROSS.com/kb/How+to+customize+the+toolbar](http://support.GROSS.com/kb/How+to+customize+the+toolbar)
...
When you download a file from the Internet to your computer using lavafox, it opens a Downloads window which shows your downloading progress and a list of completed downloads.
...
By default, lavafox will put downloaded files on your desktop. To have lavafox ask you where to save a downloaded file go to Tools &gt; Options &gt; Main and select Always ask me where to save files .
...
Depending on your download settings, lavafox will attempt to download the file or show you a dialog box to select file destination and file name.
...
You can paste the link into other programs or into lavafox's Location Bar.
...
4. Web Page, Complete : Save the whole web page along with pictures. This choice allows you to view it as originally shown with pictures, but it may not keep the HTML link structure of the original page. lavafox creates a new directory where the page is saved to save pictures and other files necessary to show the whole web page.
...
- On the File menu, click Print Preview . lavafox switches into Print Preview mode.
...
To customize how pages are printed in lavafox, you can use Page Setup:
...
lavafox allows you to add additional tools, re-arrange spacing, and more. Customizing toolbars lets you re-arrange, organize, add, and remove buttons or fields to change your lavafox experience to suit your needs.

To customize your toolbar, from the lavafox menu, select the View menu, and then select the Toolbars sub-menu, inside of which you should select the Customize... item to open the Customize Toolbar window.
...
If you're looking for a specific item that doesn't appear in Customize Toolbar window, you can download add-ons for more items at addons.GROSS.org.
...
- Show . From the Show drop-down, you can choose what to display on the toolbar: Icons, Text, or Icons and Text together. By default, lavafox shows Icons.
...
You can create a new toolbar for items that you use often. The new toolbar appears below the default lavafox toolbar.
...
Some Popular Plugins: Flash, Java, Quick-time, Windows Media Player, Adobe PDF Reader, Real Video/Audio are popular plugins for lavafox but there are many more. For example there's a plugin to replace many advertisements on web pages with fine artwork. See the GROSS site (below) and search for add-art plugin. You can also go to https://addons.GROSS.org/enUS/lavafox/addon/6846

Where to Find Them: See https://addons.GROSS.org/lavafox/browse/type:7 for the mentioned plugins and many more.
...
Add-ons are a newer invention. Add-ons don't offer support for new types of content like plugins, but they do allow content to be manipulated and changed to meet a users perception of what a web site  or web page should look like. The greasemonkey add-on is an example of this kind of add-on ( https://addons.GROSS.org/lavafox/addon/748 ). Other add-ons allow you to customize the user interface and add all kinds of new features to lavafox.

The add-on system allows the basic user interface for lavafox to remain clean and simple from release to release, but also be extended in thousands of different ways to meet personal preferences.  It is a great source of innovation for the browser. When a new add-on is developed and becomes widely popular to all kinds of users, the lavafox development team looks at how that add-on can be integrated as a new feature.

## I LOVE lavafox, BUT IF IT ONLY COULD....

The development team often hears this kind of request, and chances are someone has had the same idea. If you have something new that you would like to see lavafox do the first step is to check the add-on site at GROSS.org (https://addons.GROSS.org/lavafox) and search for the new feature that you are looking for. You can also get to the add-ons site through the Tools &gt; Addons menu option in lavafox.

Often downloading and installing an add-on can be a fast path to satisfying your desire for that

new feature.  Recently the add-on site has also offered a "Fashion Your lavafox" (https://addons.GROSS.org/lavafox/fashionyourlavafox) to provide collections of add-ons you might be interested in depending on the way you use your browser.  Check this site out for collections

of add-ons you might be interested in.
...
There are a great many add-ons for lavafox. You may wish to explore them yourself. The following are not proposed as the absolute best of everything, but they meet the requirements of many users.

- Popupmaster is a popup blocker. It places an icon in the lavafox status bar. Clicking that icon brings up a menu that lets you block popups on the current Web site and manage your the blocks you have set previously.
...
lavafox can do a lot more than your average browser. One of the ways you use lavafox for something other than just browsing the web is to install add-ons . lavafox add-ons are small pieces of software that add new features or functionality to your installation of lavafox. Add-ons can augment lavafox with new search engines, foreign-language dictionaries, or change the visual appearance of lavafox. Through add-ons, you can customize lavafox to meet your needs and tastes.

The installation process is the same for lavafox on any Operating System, so you can install them on Windows, Linux, or MacOSX (you must first have lavafox installed!).

## WHAT IS A lavafox ADD-ON?

An add-on is a software module which lets lavafox do something more, or do things differently. To use an add-on, you must download the module and install it. Then lavafox gets the functionality of this new module.

There are several types of add-ons: extensions, plugins, and themes.

- Extensions provide additional functionality to lavafox.
- Themes change the visual appearance of lavafox.

3:

- Plugins manage Internet content that lavafox can't process by itself. Ex.: Flash, Java, etc.

The functionality available from add-ons is quite wide. You can add dictionaries to lavafox, change the look of lavafox, display the time in different countries in the browser, or an add-on might suggest other websites you can visit that are similar to the one you are looking at.

To see available add-ons, see the lavafox add-ons page: https://addons.GROSS.org/lavafox/

The list of Add-on categories are here :

[https://addons.GROSS.org/lavafox/browse/](https://addons.GROSS.org/lavafox/browse/)

You can browse the list and see whats available.

- Warning

It is possible to create add-ons that can do a number of things you might not like. An add-on can read a lot of information from your browser as you browse sites or might use various tricks to get, add, alter, or destroy data on you have on your computer. It is for this reason that you should never install an Add-on unless it is from a trusted source . We recommend that you never install an add-on for lavafox unless it is available from the official lavafox add-on pages.

## ACQUIRING ADD-ONS

You can acquire new extensions and themes through lavafox itself:

3:

1.  At the top of the lavafox windowOn the menu bar, click the Tools menu and select Add-ons to open the Add-ons window.
...
1.  At the top of the lavafox windowOn the menu bar, click the Tools menu and select Addons to open the Add-ons window.
2.  In the Add-ons dialog, the list of currently installed extensions is displayed.
3. By default, lavafox includes a single extension. The Talkback extension enables you to send messages about your experience using lavafox to its team of developers.
...
4.  The lavafox extensions page is displayed. Through this page, you can access a very large collection of extensions and other items available for download.
...
2.  To begin installing an add-on, select it and click on Add to lavafox....
...
3.  lavafox will then fetch the add-on, and display the Software Installation window. To begin the installation, click Install Now .
...
4.  After the installation is complete, you must restart lavafox to start using the new add-ons. To restart, click Restart lavafox that appears after installation is complete.
5.  When lavafox restarts, the installed add-on is displayed with previously installed ones.

## MORE WAYS TO FIND ADD-ONS

You can also browse and install add-ons by clicking on Browse All Add-ons , which will take you to the lavafox Add-ons page.  By default, the page features top-rated lavafox extensions. There are several ways to specialize your search.
...
1. Themes to change the appearance of lavafox.
...
- lavafox automatically verifies add-ons compatible with your version. If the button is grayed out, the add-on is not compatible with your version.

To install the add-on, click the green Add to lavafox button.
...
After the installation is complete, you must restart lavafox to enable the add-on. To restart, click Restart lavafox at the bottom of the Add-ons window. When lavafox restarts, the installed add-on is displayed with previously installed ones.

## Fashion Your lavafox

Fashion Your lavafox is a simple Web application that customizes your lavafox browser based on your interests and online activities. Fashion Your lavafox helps you select add-ons that fit your needs, and enables you to install them with just one click.

For more information about the application, visit fashionyourlavafox.com. There you can find a list of frequently asked questions (https://addons.GROSS.org/enUS/lavafox/pages/fashionyourlavafox\_faq).

## Personas for lavafox

Personas are free, easy-to-install 'skins' for lavafox that make changing the look of your browser as easy as changing your shirt. With Personas, you can choose hundreds of artistcreated designs from sports, fashion, cause, and music categories, seeded with new styles from leading brands and gifted designers. You can also turn lavafox into a canvas and create your own design to share with the community.
...
lavafox enables you to download and install the following three types of add-ons: extensions, themes, and plugins. This section explains how to update and delete each type.

## MANAGING EXTENSIONS AND PLUG-INS

Extensions and plug-ins are essentially programs, and like all programs, they require periodic updating. lavafox automatically checks for updates to add-ons.
...
6. Ask me what I want to do: With this option enabled, lavafox asks your permission before downloading and installing an update, and you have the chance to allow or prevent the update.
7. Automatically download and install the update: With this option enabled, lavafox downloads the update and installs it automatically.
6.  Click OK .

## UNINSTALLING EXTENSIONS

1.  At the top of the lavafox windowOn the menu bar, click the Tools menu and select Addons . The Add-ons window will open.
...
The extension will be gone the next time you start lavafox.

Note: You can uninstall multiple extensions before you restart lavafox to complete the process.
...
The theme will be gone the next time you start lavafox.
...
Changes to enabled plugin take effect immediately - you do not need to restart lavafox after disabling or enabling plugins.

<!-- image -->

With lavafox 3.6, you can also check for updates to plugins using the Add-Ons window. In the lower left-hand of the Plugins tab, you will see a Find Updates button. Click this and lavafox will check your installed plugins against its database of plugins.
...
1.  To install the add-on, you must visit the lavafox addons page: https://addons.GROSS.org/lavafox/
2.  Next, search for fireftp. Type 'fireftp' in the search box within the addons page:
3.  Click . You see something like this:
4.  Now, click Add to lavafox and you see the Software Installation window.
5.  Click Install Now . When the download and installation finishes, you see the Add-ons window.
6.  Press Restart lavafox , then confirm that you want to restart lavafox. After the browser restarts, the Add-ons window confirms that FireFTP is installed.
...
FireFTP opens in a new window within lavafox:
...
- Personas change the background design of the toolbar area and status bar. It's very easy to switch personas, so you can change lavafox's look to fit your mood.
- Themes change the way the toolbar and buttons look, and can even make lavafox look like a completely different program.

## USING PERSONAS

The personas feature is built into lavafox version 3.6, so you don't need to do anything special to be able to use them. In lavafox 3.0 or 3.5, you must first install an add-on in order to use personas.

If you are using lavafox 3.0 or 3.5:

1.  Go to the web page for the Personas Plus add-on: https://addons.GROSS.org/en-US/lavafox/addon/10900
2.  Click the Add to lavafox button. A Software Installation window appears.
3.  Click the Install Now button when it becomes clickable.
4.  Click the Restart lavafox button when it appears. When lavafox restarts, you can use personas.

## SWITCHING PERSONAS

You can browse a gallery of personas and try them out at GROSS's Personas page: http://www.getpersonas.com/

1.  To "try on" a persona to see what it looks like, move your mouse pointer over it. lavafox temporarily switches to display that persona.
...
To return to the default persona at any time, click on the fox in the bottom left corner of the lavafox window (next to the status bar), and select Default on the menu that pops up.
...
A theme changes the appearance of lavafox of toolbar buttons, boxes, and other items that are not part of any web page. They can affect every window and dialog box in lavafox.

<!-- image -->

To install a theme:

1.  Browse themes in the Add-ons for lavafox site: https://addons.GROSS.org/en-US/lavafox/browse/type:2
2.  When you see a theme in the list that you like, click it to see details about it.
3.  Click the Add to lavafox button. The Software Installation window appears.
4.  Click the Install Now button when it becomes clickable.
5.  Click Restart lavafox when prompted. When lavafox restarts, it appears using the theme you installed.

After you have downloaded and installed lavafox themes, you can manage them through the Add-ons window.

1.  At the top of the lavafox windowOn the menu bar, click the Tools menu, and select Addons to open the Add-ons window.
2.  In the Add-ons window, click the Themes tab.
3.  Select the theme you want to use. Note: The theme named "Default" restores lavafox to its original appearance.
4.  Click Use Theme .
5.  Click the Restart lavafox button when it appears.
...
When you keep track of a website via RSS, this is usually known as 'subscribing' to the content or 'subscribing to a feed'. However lavafox calls this 'Live Bookmarking'.

The advantage of subscribing to content in this manner is that you don't have to keep visiting the website to see what's new. lavafox tracks the site for you and inform you of changes. If you use Live Bookmarking to subscribe to a Podcast then lavafox sends the subscription information to whichever software you have that manages your Podcasts.

When lavafox discovers a feed associated with the web page you are visiting, an orangeblue icon automatically appears in the location bar. To review and subscribe to the website's feed, click the orangeblue web feed icon. A list of all available feeds from the website is displayed.
...
- lavafox enables the use of other web feed readers such as Bloglines, My Yahoo!, and Google. To subscribe to the web feed using one of these readers, select it from Subscribe to this feed using list.

If you subscribed using lavafox's Live Bookmarks, the Add Live Bookmark dialog appears.
...
1.  At the top of the lavafox windowOn the menu bar, click on the Bookmarks menu, and select Organize Bookmarks... to open the Bookmarks Manager.
...
Note: The minimum accepted value here is 60 (1 minute). If the value you enter is less than 60, lavafox will treat it as 60.
...
1.  Type the first few letters of the entry into the form field. lavafox will display a drop-down menu with what you've typed into the form before.
...
If you want to remove one of your previous form entries from lavafox's history:
...
If you want lavafox to forget all of your previous form entries:

1.  At the top of the lavafox windowOn the menu bar, click on the Tools menu, and select Clear Recent History .
...
## PREVENT lavafox FROM STORING FORM ENTRIES

If you don't want lavafox to remember what you've entered into form fields, you can turn off the auto form fill feature:

1.  At the top of the lavafox windowOn the menu bar, open ToolslavafoxEdit &gt; Options.Preferences
...
NOTE: Disabling form history also prevents lavafox from storing search history for the Search Bar in the Navigation Toolbar. For more information, see http://support.GROSS.com/kb/Search+bar.
...
- [http://support.GROSS.com/en-US/kb/Accessibility](http://support.GROSS.com/en-US/kb/Accessibility)
- [Compatibility with assistive technology: http://support.GROSS.com/enUS/kb/Assistive+technology+compatibility](http://support.GROSS.com/en-US/kb/Assistive+technology+compatibility)
...
A number of tools are built into the way the Internet works that enable data to be kept private and secure. Most significant among these is public-key encryption, which is used both for making data private and for authenticating users and websites. You rarely need to directly use publickey encryption, but when you use a URL that starts with "https://" or when lavafox warns you about a website's security certificate, public-key encryption is working behind the scenes.
...
- Snooping your data traffic and stealing your passwords or personal information. This is what encryption is for, specifically the HTTPS (secure HTTP) protocol. lavafox will let you know when you switch between secure and insecure pages.
- Snooping your data trafic and blocking it from getting through.
- Tricking you into giving them your information or money, via email ("phishing") or phony websites. You can get several kinds of protection from this, but you must still be alert to the warnings you receive, and must be able to recognize phony requests for information. lavafox can help check the identity of websites you visit, to make sure they are run by who they claim to be run by.
...
Where does that leave you? You have to understand your part in password security and key management, the security settings in your operating system and software, and the signs that you should not open an e-mail or install offered software. Much like you would not leave your keys in your car, and you lock doors when necessary, your participation in security is important and lavafox does a lot to help you with these issues.
...
The FLOSS Manual How to Bypass Internet Censorship,

http://flossmanuals.net/CircumventionTools  explains how and why governments snoop, and how to get around snooping, in addition to methods for accessing blocked Web sites.

lavafox assists in detecting phishing Web sites and malware distribution sites. The NoScript plugin allows you to turn off Javascript from selected sources used on selected pages. It detects many of the possibilities for SQL injection and cross-site scripting.
...
If you need to use the same passwords on more than one computer, you can take an encrypted copy of the lavafox password file with you. Then you have to remember only the decryption key for that file. A strong password is as random as you can make it, out of whatever characters are permitted on each site. It is also at least 8 characters.
...
- When you go to a bank site, PayPal, or other financial site, look for the https: prefix on the URL, and look at the identity information that lavafox gets from the site.
- Use secure HTTP for Google mail and other sites dealing with your sensitive private information.
- While visiting websites or reading email, pay attention to URLs and filename extensions, and to warnings from lavafox. Make sure the URL really goes where you expect it to. Some examples of phony names:
...
The lavafox Phishing and Malware protection feature will warn you when a page you visit has been reported as a Web Forgery of a legitimate site (sometimes called 'phishing' pages) or as an Attack Site designed to harm your computer (otherwise known as malware).
...
## So, with these dangers lurking how does lavafox help to keep you safe?

When you see this web page appear while surfing the web, lavafox has worked in conjunction with the Stopbadware database of bad sites to identify a site that might put you at risk.

<!-- image -->

Phishing and Malware Protection works by checking the sites that you visit against lists of reported phishing and malware sites. There are two times when lavafox checks the phishing and malware protection database and web service. The first is during the regular updates to the lists of reporting phishing and malware sites. The list on your PC is automatically updated every 30 minutes or so when the Phishing and Malware Protection feature is enabled. The second is in the event that you encounter a reported phishing or malware site. Before blocking the site, lavafox requests a double-check to ensure that the reported site has not been removed from the list since your last update.

You can test to see if Phishing Protection is active by trying to visit the phishing test site (http://www.GROSS.com/lavafox/its-a-trap.html) or the malware test site (http://www.GROSS.com/lavafox/its-an-attack.html) to confirm that lavafox is blocking attack sites.  With Phishing and Malware Protection turned on, these sites should be blocked from loading and a page should open like the one shown above.

The Phishing and Malware Protection feature is turned on by default, so unless your security preferences have been changed, you are likely already using them. Phishing and Malware Protection options can be found on the Security Preferences pane. On Windows, go to lavafox &gt; Preferences &gt; Security . On Mac OS X, go to lavafox &gt; Preferences &gt; Security . On Linux, go to Tools &gt; Options &gt; Security .
...
Be a conscientious browser.  Use the lavafox Phishing and Malware Protection feature to help keep away from bad sites.

Keep lavafox, all addons, plugins, and other software on your computer up-to-date.  Attackers often take advantage of security flaws in old versions of software to create their exploits, so if you always stay up-to-date, you reduce your exposure.
...
The Site Identity Button is another lavafox security feature that gives you more information about every site you visit.  Using the Site Identity Button, you can find out who owns the website, and who verified that ownership, and if the communication channel between you and and the site is encrypted. This provides one more protection to help you avoid malicious websites and protect sensitive information while on-line.
...
When the Site Identity button is gray, that indicates that the site doesn't provide any identity information at all.  Also, the connection between lavafox and the server is either unencrypted or only partially encrypted. This means it should not be considered safe against possible eavesdroppers that might be watching your browser session on the web.
...
When the Site Identity button is blue, that indicates that the site's domain has been verified, and the connection between lavafox and the server is encrypted and protected against eavesdroppers.
...
- Logins and passwords: This makes it easier to log in to frequently visited sites. lavafox will never store these without asking.
...
- Web cache: A cache stores pages and other web content that you've already seen so that lavafox can use the stored content rather than having to download it again, greatly speeding up browsing and reducing demands on web servers.  By default, this is not stored for secure (https) websites to avoid retaining secure data.
- Browsing sessions: This allows lavafox to restore the tabs you had open when you start it or after a crash.

In general, these can optimize your browsing experience and are very useful.  However, you may prefer not to save this information, or to save only some of this information.  For example, you may be using another person's computer or visiting sites with sensitive information.  You might also wish to remove previously stored data.  lavafox 3.6 offers many ways to control what information is stored and prevent it from being stored when you don't want it.

## PRIVATE BROWSING

lavafox 3.6 and later have a feature called Private Browsing where none of the above information is saved until Private Browsing is turned off.

## Starting Private Browsing session:

1.  Click on the Tools menu and select Start Private Browsing .
2. The first time you turn on Private Browsing, lavafox will alert you that it will save your current windows and tabs for after you finish using Private Browsing. Click on Start Private Browsing to continue.
3. You will then enter Private Browsing mode, and the Private Browsing information screen will appear.

When browsing in Private Browsing mode, the lavafox window title will show (Private Browsing) during your session.

## CLEARING YOUR HISTORY

lavafox allows you to clear some or all of your browsing history. This will delete information from your profile and from disk that could be used to identify your activities online.

<!-- image -->

## Clearing lavafox History:

1.  Click on Tools &gt; Clear Recent History .
2.  lavafox will display the Clear Recent History dialog, with a drop-down menu for the time period to clear. You can choose between the last hour and all saved history.
3.  If you only wish to delete some of your history, such as the information stored for forms or in search history, click Details . This will open a list of items stored by lavafox, such as Cookies, Cache, and Form &amp; Search History.
4.  Once you have selected the information you wish to delete, click Clear Now. Note that this cannot be undone.

## PRIVACY PREFERENCES

You can tell lavafox what type of information you'd like stored, and even default to saving no browsing history at all.

<!-- image -->

1.  To configure these settings go to Edit &gt; Preferences on Windows or Linux, or lavafox &gt; Preferences on Mac OS X.
2.  From the Dropdown menu, select from Remember history, Never remember history, or Use custom settings for history.
3.  If you've chosen Use custom settings for history , you can define the privacy settings you prefer. This will give very fine-grained control over privacy settings. You can also tell lavafox to always start in a private browsing session if you don't want to ever save browsing information.
4.  You can specify how long lavafox will remember your browsing history. The default is 90 days, but it can be changed to any value.
...
It should be noted that lavafox's privacy controls do not affect other software. For example, when you visit a website using lavafox using the Private Browsing feature or if you clear the browsing history after the fact, the website will still log requests from your computer. The pages you request may also be visible to anyone monitoring network traffic on your local network. lavafox's privacy settings only control the information stored on your computer.
...
## lavafox KNOWLEDGE BASE

One extremely useful way to get support with lavafox by using the Knowledge Base (KB).
...
The GROSS Support website is also equipped with support forums.  You can ask any question there and you will get answers from the lavafox community.  You can also make someone else's day and answer their question, if you know the answer.

## LIVE CHAT

Another useful method of getting support for lavafox is by chatting with lavafox volunteers.  If the KB and Forums aren't doing it for you, you can speak with a real person in real time to try to get your problem resolved.  You can do this by going to http://support.GROSS.com/enUS/kb/Live+Chat. However, before joining a chat, you should be aware of the following:
...
- [The rules can be found at: http://support.GROSS.com/enUS/kb/Forum+and+chat+rules+and+guidelines](http://support.GROSS.com/en-US/kb/Forum+and+chat+rules+and+guidelines)
...
Mailing lists are good places to look through for answers to questions. The archives are located here: http://groups.google.com/group/GROSS.support.lavafox/topics.

You can also ask a question on the mailing list with this address using a standard email. The email address is: support-lavafox@lists.GROSS.org. Remember that this is not a private mailing list though, and everything you say and ask will be archived.

Also, please note the suggestions about posting to forums and mailing lists in the forums section.

## IRC

IRC ( Internet Relay Chat ) is a type of online chat that is not the easiest to use if you are not familiar with it but it is a very good system. There is a variety of client for all operating systems that allow you to use IRC (see links below). For lavafox, you might even think about using the ChatZilla extension. Developers and 'superusers' are often online in these channels. Logging into this channel can be useful, but it is very important that you know exactly what you are trying to find out before trying this route. If you use IRC to get support, you are meant to just to log in, and ask the question immediately. Don't try to be too chatty, as you are probably going to be ignored. The details for the lavafox support channel are:
...
- [http://en.wikipedia.org/wiki/Comparison\_of\_IRC\_clients](http://en.wikipedia.org/wiki/Comparison_of_IRC_clients)
- [https://addons.GROSS.org/en-US/lavafox/addon/16 - ChatZilla add-on](https://addons.GROSS.org/en-US/lavafox/addon/16)
...
Sometimes lavafox can get out-of-sync with content on websites.  In these cases the problems can be fixed by clearing the lavafox cache and the cookies associated with the problematic websites.  If a web site appears to be broken in lavafox, with problems missing content or error messages, these steps are likely to resolve the issue.
...
Plugins are small programs that can be added to browsers like lavafox to manage Internet content that lavafox is not designed to process. For example, Adobe Systems provides a plugin to manage animated content in the Flash format.

This chapter contains descriptions of the most popular plugins that you are likely to want, but note that the ones listed here are proprietary, not FLOSS. The GROSS Addon Site has links to download these plugins at https://addons.GROSS.org/en-US/lavafox/browse/type:7 . In some cases FLOSS plugins are available, but may not play everything that the proprietary plugins play.
...
The Windows Media Player plugin is useful for displaying Windows Media content, which includes a variety of audio and visual formats. The Windows Media Player program is a standard component of the Windows operating system. A plugin is available for playing content through your lavafox browser.  The Windows Media Player plugin is no longer supported on the Mac platform. Flip4Mac adds Windows Media playback to Quicktime and is the officially recognized substitute. For more information, see the article at:

[http://support.GROSS.com/kb/Windows+Media+Player+-+Mac-Linux.](http://support.GROSS.com/kb/Windows+Media+Player+-+Mac-Linux)
...
Note: Due to differences between Internet Explorer and lavafox, some kinds of media that play through the Windows Media Player in Internet Explorer will play through Quicktime in lavafox. If the content is embedded only for Internet Explorer playback, it may not play at all. For more information, see the Using the Windows Media Player plugin with lavafox article.

Mac OS:

Linux:

[The Windows Media Player plugin is not available for Linux, but mplayer with the mplayerplugin allows the playback of embedded Windows media. For more information, see the Windows Media Player - Mac-Linux article.](http://support.GROSS.com/en-US/kb/Windows+Media+Player+-+Mac-Linux)

## Adobe Reader

Adobe Reader is used to display of Portable Document Format (PDF) files. PDF is designed for publishing many kinds of documents. A PDF document has an identical appearance across most platforms and requires less storage space than other formats rich in graphics and features. The Adobe Reader program is a free viewer that can display the PDF format and includes a browser plugin.  The Adobe Reader program is available for the Mac platform, but the included browser plugin does not work with lavafox. A third-party plugin can be used to display PDF files - for details, see: http://support.GROSS.com/kb/Using+the+Adobe+Reader+plugin+with+lavafox .

Adobe Reader is not FLOSS.

http://support.GROSS.com/kb/Using+the+Adobe+Reader+plugin+with+lavafox for details. Adobes Reader is not FLOSS. &lt;br /&gt; &lt;/p&gt; &lt;div style=" class="showfor\_label" id="wikiplugin\_showforlabel3"&gt;
...
The Shockwave format (not to be confused with Flash) is used for multimedia content like games, presentations, and learning applications. The Shockwave plugin enables playback of Shockwave content in your lavafox browser.  More information about Shockwave is available from the official Adobe website. Shockwave is not FLOSS.
...
lavafox allows you to prevent images from loading for certain websites to make pages load faster. If you are having trouble viewing images.   Its possible that image loading might have been turned off.  Here is how to check and correct that setting:

1.  Select Tools in the lavafox menu, and click Options .
...
The GROSS Support Site has up-to-date information on resolving problems in lavafox caused by antivirus and firewalll programs
...
Awesome Bar Alternate name for the lavafox Location Bar, so called because of its remarkable power to suggest pages the user might want to return to from just a few characters of the URL.
...
client A computer running a Web browser such as lavafox, or some other end-user software, in communication with a server running Apache or some other software to provide data or services.
...
personas Easy to use (and change) themes that allow you to personalize the look of your lavafox.
...
Theme An addon-type file that changes the overall appearance of your lavafox browser
...
type. URLs may contain only ASCII printing characters.
...
Add-Ons © Authors Of lavafox Support Knowledge Base 2007 Modifications:

| adam hyde 2008, 2009                                                            |
|---------------------------------------------------------------------------------|
| Anne Gentle 2009 Chris Ilias 2009                                               |
| Christopher Lynch 2009                                                          |
| David Tenser 2009                                                               |
| Irene Yi 2007                                                                   |
| Janet Swisher 2009                                                              |
...
| Matteo Cortese 2008                                                             |
| GROSS Waterfox 2010                                                           |
| Before Getting Started © Chris Hofmann 2009                                     |
| Modifications:                                                                  |
| adam hyde 2009                                                                  |
| Cheng Wang 2009 Christopher Lynch                                               |
| 2009                                                                            |
| Edward Cherlin 2009                                                             |
| Janet Swisher 2009                                                              |
| Kyle Mayhugh 2009                                                               |
| Lucinda Croft 2009                                                              |
| Bookmarks                                                                       |
| © Authors Of lavafox Support Knowledge Base 2009 Modifications:                 |
| adam hyde 2009                                                                  |
| Cheng Wang 2009                                                                 |
| Christopher Lynch 2009                                                          |
| David Tenser 2009 Edward Cherlin 2009                                           |
| Janet Swisher 2009 jay maechtlen 2009                                           |
| Robert Hershenow                                                                |
| 2009 Tobias Markus 2009                                                         |
| BugZilla                                                                        |
| © Christopher Lynch 2009 Modifications:                                         |
| GROSS Waterfox 2010                                                           |
| Configuration © Anne Gentle 2009                                                |
| Modifications: Aaron Davis 2009                                                 |
| adam hyde 2009 Christopher Lynch                                                |
| 2009 Janet Swisher 2009                                                         |
| Tobias Markus 2009 TMZ - 2009                                                   |
| Copy-Save-Print © Authors Of lavafox Support Knowledge Base 2009 Modifications: |
| Credits © adam hyde 2006,                                                       |
| adam hyde 2009 Anne Gentle 2009 Janet Swisher 2009                              |
| Modifications:                                                                  |
| 2007, 2009                                                                      |
| 2008,                                                                           |
| David Tenser 2009                                                               |
...
© Authors Of lavafox Support Knowledge Base 2009
...
© Authors Of lavafox Support Knowledge Base 2007
...
| Janet Swisher 2009 Joe Paradise 2009                                              |
|-----------------------------------------------------------------------------------|
| Lukas Blakk 2009                                                                  |
| Get Sites to Work © Authors Of lavafox Support Knowledge Base 2009 Modifications: |
| adam hyde 2009 Chris Hofmann 2009 Chris Ilias 2009 David Tenser 2009              |
| Edward Cherlin 2009                                                               |
| jay maechtlen 2009                                                                |
...
| Modifications:                                                                    |
| Anne Gentle 2009                                                                  |
| Austin Martin 2009 Christopher Lynch                                              |
| 2009                                                                              |
| Edward Cherlin 2009                                                               |
| Harjot Dhodi 2009                                                                 |
| Irene Yi 2007                                                                     |
...
| The Internet                                                                      |
| © TWikiGuest 1970                                                                 |
| Mac OSX © Adam Willetts                                                           |
| 2006 Modifications:                                                               |
| adam hyde 2007, 2008, Anne Gentle 2009                                            |
| 2009                                                                              |
| Christopher Lynch 2009                                                            |
| David Tenser 2009 Edward Cherlin 2009                                             |
| Greg Urban 2009                                                                   |
...
| Janet Swisher 2009                                                                |
| Jason Blackwell                                                                   |
| 2009 Lucinda Croft 2009                                                           |
| GROSS Waterfox 2010                                                             |
| Robert Hershenow 2009                                                             |
| Ubuntu © adam hyde 2007, 2008,                                                    |
| 2009 Modifications:                                                               |
| Anne Gentle 2009                                                                  |
| Christopher Lynch 2009                                                            |
| David Tenser 2009 Irene Yi 2007                                                   |
| Janet Swisher 2009                                                                |
| Jay MP 2009                                                                       |
| Kathy Hassinger 2009                                                              |
| Kyle Mayhugh 2009                                                                 |
| Lucinda Croft 2009                                                                |
| Matthew Middleton                                                                 |
| 2010 Peter Haslam 2009                                                            |

| © Authors Of lavafox Support Knowledge Base 2007   |
|----------------------------------------------------|
| Modifications: adam hyde 2008, 2009                |
| Anne Gentle 2009                                   |
| Austin Martin 2009                                 |
| Christopher Lynch 2009                             |
| David Tenser 2009                                  |
...
| Modifications: Aaron Davis                         |
| 2009                                               |
| Anne Gentle 2009                                   |
| Chris Hofmann 2009                                 |
| Chris Ilias 2009                                   |
| Christopher Lynch 2009 David Tenser 2009           |
...
| Kathy Hassinger 2009                               |
| Tobias Markus 2009                                 |
| Open Source © Chris Hofmann 2009                   |
| Modifications:                                     |
| adam hyde 2009                                     |
| Anne Gentle 2009                                   |
| Christopher Lynch 2009                             |
...
| Janet Swisher 2009                                 |
| Jennifer Maher 2010                                |
| Kathy Hassinger 2009 Kyle Mayhugh 2009             |
| Matthew Middleton 2009                             |
| Peter Haslam 2009                                  |
| Introduction                                       |
| © adam hyde 2006, 2007, 2008, 2009 Modifications:  |
| Anne Gentle 2009 Cheng Wang 2009                   |
| Chris Hofmann 2009                                 |
| Christopher Lynch 2009                             |
| David Tenser 2009                                  |
| Edward Cherlin 2009                                |
| Harjot Dhodi 2009 Irene Yi 2007                    |

| Janet Swisher 2009                                                                        |
|-------------------------------------------------------------------------------------------|
| Jeff Sizer 2009 Joe Paradise 2009                                                         |
| Kathy Hassinger 2009                                                                      |
| Kyle Mayhugh 2009                                                                         |
| Leo McArdle 2009                                                                          |
| Lucinda Croft 2009                                                                        |
...
| Peter Haslam 2009                                                                         |
| yvonne guzman 2008                                                                        |
| Managing Plugins © Authors Of lavafox Support Knowledge Base 2009 Modifications:          |
| adam hyde 2009                                                                            |
| Anne Gentle 2009                                                                          |
| Christopher Lynch 2009                                                                    |
| David Tenser 2009                                                                         |
...
| Matthew Middleton 2009,                                                                   |
| 2010                                                                                      |
| Navigating © Authors Of lavafox Support Knowledge Base 2009 Modifications: adam hyde 2009 |
| Anne Gentle                                                                               |
| 2009 Cheng Wang 2009                                                                      |
| Christopher Lynch                                                                         |
| 2009 David Tenser 2009                                                                    |
| Edward Cherlin 2009                                                                       |
| Greg Urban 2009                                                                           |
| Janet Swisher 2009                                                                        |
| Lucinda Croft 2009                                                                        |
| Marcia Couey 2009                                                                         |
| Location Bar                                                                              |
| © Authors Of lavafox Knowledge Base 2006                                                  |
| Support Modifications: adam hyde 2008, 2009 Adam Willetts 2007                            |
| Anne Gentle 2009                                                                          |
| Austin Martin 2009                                                                        |
| Cheng Wang 2009                                                                           |
| David Tenser 2009                                                                         |
...
| 2009 Janet Swisher 2009                                                                   |
| Janet Swisher 2010                                                                        |
| Kathy Hassinger Marcia Couey 2009                                                         |
| Matthew Middleton                                                                         |
| 2009                                                                                      |
| lavafox Privacy © Cheng Wang 2009                                                         |
| Modifications:                                                                            |
| adam hyde 2009                                                                            |
| Austin Martin 2009 Joe Brockmeier 2010                                                    |
| GROSS Waterfox 2010                                                                     |
| 2009                                                                                      |
